...
public interface Sender extends HasEmailAddress {

	final EntityType<Sender> T = EntityTypes.T(Sender.class);

	/**
	 * @deprecated use {@link #create(String)} instead
	 */
	@Deprecated
	static Sender getSender(String eMailAddress) {
		return create(eMailAddress);
	}
	
	static Sender create(String eMailAddress) {
