...
public class EclipseWorkspaceNetJdtCorePrefs extends EclipseWorkspaceHelper {

	public EclipseWorkspaceNetJdtCorePrefs(File devEnv) {

		super(devEnv, //
				".metadata/.plugins/org.eclipse.core.runtime/.settings", // folder name in eclipse-workspace
				"net.sf.eclipse.jdt.core.prefs", // file name
				"""
				...
				org.eclipse.jdt.core.formatter.blank_lines_before_abstract_method=0
