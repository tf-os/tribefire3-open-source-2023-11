...
public class OverviewPageRenderer extends AbstractPageRenderer {
	
	public OverviewPageRenderer() {
		super("overview.ftlh");
	}
	...
	protected Map<String, Object> dataModel(PageRenderingContext context) {
		...
		dataModel.put("assets", context.getDisplayInfos().getMarkdownFilesPerAsset());
	...
	protected UniversalPath targetFile(PageRenderingContext context) {
		return UniversalPath.start("overview.html");
	}
