...
@Description("Executes a ServiceRequest in another freshly spawned jinni")
public interface SpawnedJinniRequest extends PlatformRequest, GenericProcessingRequest, HasServiceRequest {

	EntityType<SpawnedJinniRequest> T = EntityTypes.T(SpawnedJinniRequest.class);
