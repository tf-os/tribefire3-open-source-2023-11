 ...
 * @author peter.gazdik
 */
public interface StringIdEntity extends HibernateAccessEntity, StandardStringIdentifiable {

	EntityType<StringIdEntity> T = EntityTypes.T(StringIdEntity.class);
