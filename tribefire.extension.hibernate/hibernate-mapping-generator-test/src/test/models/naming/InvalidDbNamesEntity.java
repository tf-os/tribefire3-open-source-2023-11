...
public interface InvalidDbNamesEntity extends StandardIdentifiable {
	...
	String get_column();
	void set_column(String _column);

	String get_column_();
	void set_column_(String _column_);

	String get___column();
	void set___column(String ___column);

	String get_$column() ;
	void set_$column(String _$column) ;

	String get___$column() ;
	void set___$column(String ___$column) ;

	String get$column() ;
	void set$column(String $column) ;

	String get$$$column() ;
	void set$$$column(String $$$column) ;

	String get$_column() ;
	void set$_column(String $_column) ;
	...
	String get__Column();
	void set__Column(String __Column);

	String getColumn_();
	void setColumn_(String column_);
	...
	String get_boolean();
	void set_boolean(String _boolean);
