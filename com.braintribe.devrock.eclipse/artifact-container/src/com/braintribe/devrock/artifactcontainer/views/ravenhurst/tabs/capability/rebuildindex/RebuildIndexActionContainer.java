...
// ============================================================================
package com.braintribe.devrock.artifactcontainer.views.ravenhurst.tabs.capability.rebuildindex;
 ...
 *
 */
public class RebuildIndexActionContainer extends AbstractViewActionContainer<RavenhurstViewTab> implements ViewActionController<RavenhurstViewTab> {
	...
	public ViewActionController<RavenhurstViewTab> create() {
		// purge
		ImageDescriptor pomImportImageDescriptor = ImageDescriptor.createFromFile( RebuildIndexActionContainer.class, "rebuild_index.gif");
		rebuildAction = new Action("Rebuild the RH index of this repository", pomImportImageDescriptor) {

			@Override
			public void run() {		
				RavenhurstViewTab viewTab = activeTabProvider.provideActiveTab();
				viewTab.rebuildIndex();
			}			
		};
		toolbarManager.add( rebuildAction);
		menuManager.add( rebuildAction);
		return this;
	}
