...
public class RefreshDropdownHandler extends UpdateContainerDropdownHandler {

	public RefreshDropdownHandler() {
		super(ArtifactContainerUpdateRequestType.refresh);		
	}
