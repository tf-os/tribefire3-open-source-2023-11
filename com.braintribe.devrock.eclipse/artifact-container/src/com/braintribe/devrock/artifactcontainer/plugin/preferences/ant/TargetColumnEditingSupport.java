...
public class TargetColumnEditingSupport extends AbstractColumnEditingSupport {
	
	private TableViewer viewer;
	
	public TargetColumnEditingSupport(TableViewer viewer) {
		super(viewer);
		this.viewer = viewer;
	}
	...
	protected void setValue(Object element, Object value) {
		AntTarget setting = (AntTarget) element;
		setting.setTarget( (String) value);
