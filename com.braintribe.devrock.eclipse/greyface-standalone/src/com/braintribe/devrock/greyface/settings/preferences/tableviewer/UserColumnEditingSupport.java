...
public class UserColumnEditingSupport extends AbstractColumnEditingSupport {
	private TableViewer viewer;

	public UserColumnEditingSupport(TableViewer viewer) {
		super(viewer);
		this.viewer = viewer;
	}
