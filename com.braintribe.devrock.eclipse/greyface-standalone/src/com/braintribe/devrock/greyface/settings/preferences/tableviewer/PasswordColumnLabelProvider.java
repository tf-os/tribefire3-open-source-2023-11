...
public class PasswordColumnLabelProvider extends ColumnLabelProvider {
	...
	public String getToolTipText(Object element) {
		RemoteRepository setting = (RemoteRepository) element;	
		return "the password for the user [" + setting.getUser() + "] required to access [" + setting.getName() + "]";
	}
