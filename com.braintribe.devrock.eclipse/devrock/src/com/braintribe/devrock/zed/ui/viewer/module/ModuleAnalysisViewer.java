...
public class ModuleAnalysisViewer implements IDisposable {
	...
	public ModuleAnalysisViewer( ZedViewingContext context) {
	...
	public Composite createControl( Composite parent, String tag) {
        ...
        nameColumn.getColumn().setToolTipText( "Findings of the module analysis");
        nameColumn.getColumn().setWidth(1000);
        
        viewLabelProvider = new ViewLabelProvider();
        viewLabelProvider.setUiSupport(uiSupport);
        viewLabelProvider.setUiSupportStylersKey("zed-module-analysis-view");
