...
public interface LdapConnectionCheckResult extends CheckResult, HasNotifications {

	final EntityType<LdapConnectionCheckResult> T = EntityTypes.T(LdapConnectionCheckResult.class);
