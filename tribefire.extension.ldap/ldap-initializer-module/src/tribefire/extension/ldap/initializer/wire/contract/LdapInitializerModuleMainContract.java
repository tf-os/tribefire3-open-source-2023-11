...
public interface LdapInitializerModuleMainContract extends WireSpace {

	LdapInitializerModuleContract initializer();

	LdapInitializerModuleModelsContract models();
