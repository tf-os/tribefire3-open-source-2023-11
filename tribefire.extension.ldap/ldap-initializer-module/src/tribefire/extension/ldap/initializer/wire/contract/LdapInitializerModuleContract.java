...
public interface LdapInitializerModuleContract extends WireSpace {

	void cortexConfiguration();

	LdapConnection connection();

	LdapUserAccess ldapUserAccess();

	LdapAccess ldapAccess();

	LdapAuthentication authentication();

	boolean isLdapConfigured();

	HealthCheckProcessor connectivityHealthCheck();
