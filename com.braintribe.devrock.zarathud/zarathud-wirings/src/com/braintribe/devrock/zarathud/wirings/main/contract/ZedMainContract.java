...
// ============================================================================
package com.braintribe.devrock.zarathud.wirings.main.contract;
...
public interface ZedMainContract extends WireSpace {

	ZedCoreContract coreContract();
	
	ZedForensicsContract forensicsContract();
	
	ZedConsoleOutContract consoleOutContract();
}
