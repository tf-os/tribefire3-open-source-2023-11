...
public interface LocalCacheChangeState extends CacheAdmin {

	EntityType<LocalCacheChangeState> T = EntityTypes.T(LocalCacheChangeState.class);

	@Override
	EvalContext<? extends CacheChangeStateResult> eval(Evaluator<ServiceRequest> evaluator);
