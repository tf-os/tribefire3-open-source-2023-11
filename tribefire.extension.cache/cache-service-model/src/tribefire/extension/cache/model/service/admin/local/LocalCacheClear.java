...
public interface LocalCacheClear extends CacheAdmin {

	EntityType<LocalCacheClear> T = EntityTypes.T(LocalCacheClear.class);

	@Override
	EvalContext<? extends CacheClearResult> eval(Evaluator<ServiceRequest> evaluator);
