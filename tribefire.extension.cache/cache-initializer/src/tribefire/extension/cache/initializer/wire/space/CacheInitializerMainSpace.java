...
import tribefire.extension.cache.initializer.wire.contract.RuntimePropertiesContract;

@Managed
public class CacheInitializerMainSpace implements CacheInitializerMainContract {

	@Import
	private CacheInitializerContract initializer;
	...
	@Override
	public CacheInitializerContract initializer() {
		return initializer;
	}

	@Override
	public CacheInitializerModelsContract models() {
		return models;
	}
