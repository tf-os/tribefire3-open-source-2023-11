...
// ============================================================================
package tribefire.extension.cache.initializer.wire.contract;
...
public interface ExistingInstancesContract extends WireSpace {
	...
	@GlobalId(CacheConstants.MODULE_GLOBAL_ID)
	Module module();
	...
	@GlobalId("model:" + CacheConstants.DEPLOYMENT_MODEL_QUALIFIEDNAME)
	GmMetaModel deploymentModel();

	@GlobalId("model:" + CacheConstants.SERVICE_MODEL_QUALIFIEDNAME)
	GmMetaModel serviceModel();

	@GlobalId("model:" + CacheConstants.DATA_MODEL_QUALIFIEDNAME)
