...
// ============================================================================
package tribefire.extension.drools.pd_processing.test.wire;
...
public enum DroolsPdProcessingTestWireModule implements WireTerminalModule<DroolsPdProcessingTestContract> {
	INSTANCE;
