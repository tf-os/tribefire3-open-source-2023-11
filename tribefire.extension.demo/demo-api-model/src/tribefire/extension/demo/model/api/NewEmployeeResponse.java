...
public interface NewEmployeeResponse extends HasNotifications, HasInducedManipulation {
	
	EntityType<NewEmployeeResponse> T = EntityTypes.T(NewEmployeeResponse.class);
