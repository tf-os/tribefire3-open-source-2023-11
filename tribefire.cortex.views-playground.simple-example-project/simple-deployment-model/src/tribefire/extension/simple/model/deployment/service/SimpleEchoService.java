...
/**
 * The <code>SimpleEchoService</code> is a simple service that receives a message via a <code>SimpleEchoRequest</code>
 * and echoes them by returning a <code>SimpleEchoResponse</code>.<br>
 * This is just a very simple example for a (DDSA) service.
 * <p>
 * This is the denotation type that represents the respective <code>SimpleEchoService</code> implementation. For more
 * information on denotation types see
 * {@link tribefire.extension.simple.model.deployment.access.SimpleInMemoryAccess}.
 *
