...
/**
 * A simple {@link HttpServlet} which processes {@code GET} requests. It generates a basic HTML page with information
 * about the incoming request. The content of the response page to some extent depends on the terminal configuration,
 * see {@link #setPrintRequestHeaders(boolean)} and {@link #setPrintRequestParameters(boolean)}..
 *
