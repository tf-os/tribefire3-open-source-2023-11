 ...
 * The main purpose of this class is to provide an example of how to implement a so-called entity type expert, i.e. a
 * class which provides utility methods to work with entities of particular type.
 *
...
public interface PersonExpert {
	...
	/**
	 * Returns the parents of the specified <code>person</code>, i.e. {@link Person#getMother() mother} and
	 * {@link Person#getFather()} (unless <code>null</code>).
	 *
