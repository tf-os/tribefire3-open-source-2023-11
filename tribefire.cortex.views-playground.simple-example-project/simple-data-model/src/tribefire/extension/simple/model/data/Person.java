...
/**
 * A <code>Person</code> represents a natural person and holds information such as {@link #getFirstName() first} and
 * {@link #getLastName() last} name, {@link #getSsn() social security number}, {@link #getDateOfBirth() date of birth}
 * and {@link #getGender() gender}. Furthermore a person has relationships to other persons, i.e. {@link #getMother()
 * mother}, {@link #getFather() father} and {@link #getChildren() children}. Similar to a {@link Company#getAddress()
 * company} a person also has an {@link #getAddress() address}.
 */
