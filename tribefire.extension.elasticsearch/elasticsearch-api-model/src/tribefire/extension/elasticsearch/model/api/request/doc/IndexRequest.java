...
@Abstract
public interface IndexRequest extends ElasticsearchRequest {

	EntityType<IndexRequest> T = EntityTypes.T(IndexRequest.class);
	...
	@Mandatory
	@Name("Index names")
	@Description("Names of the indexes.")
	List<String> getIndexNames();
	void setIndexNames(List<String> indexNames);
