...
public class NullStringifier implements Stringifier<Void, StringifierContext> {
	@Override
	public String stringify(Void operand, StringifierContext context) throws QueryStringifierRuntimeException {
		return "null";
	}
}
