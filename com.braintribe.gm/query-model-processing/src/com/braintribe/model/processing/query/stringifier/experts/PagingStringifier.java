...
public class PagingStringifier implements Stringifier<Paging, BasicQueryStringifierContext> {
	@Override
	public String stringify(Paging paging, BasicQueryStringifierContext context) throws QueryStringifierRuntimeException {
		StringBuilder queryString = new StringBuilder();
		
		queryString.append(" limit ");
		queryString.append(paging.getPageSize());
		
		queryString.append(" offset ");
		queryString.append(paging.getStartIndex());
