...
public class EntitySignatureParameterProvider implements SingleParameterProvider<EntitySignature> {
	@Override
	public Object provideParameter(EntitySignature function) {
