...
public class CollectionStringifier implements Stringifier<Collection<?>, StringifierContext> {
	@Override
	public String stringify(Collection<?> collection, StringifierContext context) throws QueryStringifierRuntimeException {
