...
public abstract class AbstractOrderingStringifier<O extends Ordering> implements Stringifier<O, BasicQueryStringifierContext> {
	@SuppressWarnings("unused")
	public String stringifyOrdering(O ordering, BasicQueryStringifierContext context, String orderingPart) throws QueryStringifierRuntimeException {
		StringBuilder queryString = new StringBuilder();

		if (orderingPart.length() > 0) {
			queryString.append(" order by ");
			queryString.append(orderingPart);
		}
