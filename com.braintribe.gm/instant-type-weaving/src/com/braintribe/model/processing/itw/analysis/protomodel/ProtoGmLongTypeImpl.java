 ...
 * @author peter.gazdik
 */
public class ProtoGmLongTypeImpl extends ProtoGmSimpleTypeImpl implements ProtoGmLongType {

	public ProtoGmLongTypeImpl() {
		setTypeSignature("long");
		setGlobalId("type:long");
	}
