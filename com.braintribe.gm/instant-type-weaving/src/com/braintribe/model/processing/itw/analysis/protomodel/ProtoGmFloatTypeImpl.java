 ...
 * @author peter.gazdik
 */
public class ProtoGmFloatTypeImpl extends ProtoGmSimpleTypeImpl implements ProtoGmFloatType {

	public ProtoGmFloatTypeImpl() {
		setTypeSignature("float");
		setGlobalId("type:float");
	}
