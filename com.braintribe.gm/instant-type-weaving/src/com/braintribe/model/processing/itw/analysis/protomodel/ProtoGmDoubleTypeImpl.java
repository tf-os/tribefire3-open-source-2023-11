 ...
 * @author peter.gazdik
 */
public class ProtoGmDoubleTypeImpl extends ProtoGmSimpleTypeImpl implements ProtoGmDoubleType {

	public ProtoGmDoubleTypeImpl() {
		setTypeSignature("double");
		setGlobalId("type:double");
	}
