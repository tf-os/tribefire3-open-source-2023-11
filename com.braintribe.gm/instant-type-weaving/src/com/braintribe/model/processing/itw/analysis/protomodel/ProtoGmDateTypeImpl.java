 ...
 * @author peter.gazdik
 */
public class ProtoGmDateTypeImpl extends ProtoGmSimpleTypeImpl implements ProtoGmDateType {

	public ProtoGmDateTypeImpl() {
		setTypeSignature("date");
		setGlobalId("type:date");
	}
