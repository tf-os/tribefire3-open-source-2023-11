 ...
 * @author peter.gazdik
 */
public class ProtoGmDecimalTypeImpl extends ProtoGmSimpleTypeImpl implements ProtoGmDecimalType {

	public ProtoGmDecimalTypeImpl() {
		setTypeSignature("decimal");
		setGlobalId("type:decimal");
	}
