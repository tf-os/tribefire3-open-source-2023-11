...
public interface ManagedGmSession extends NotifyingGmSession, HasResourceReadAccess, EntityManager {
	...
	/**
	 * expects the manipulations to be <tt>remote</tt>, i.e. does not use entities, but EntityReferences.
	 * 
	 * @deprecated use manipulate() instead
	 */
	@Deprecated
	ManipulationReport applyManipulation(Manipulation manipulation) throws GmSessionException;
