...
public class JseOutputTest {
	...
	public void testJse() throws Exception {
		...
		Object assembly = getXmlMarshaller().unmarshall(new FileInputStream(file));

		FileOutputStream out = new FileOutputStream("jseCortexOld.txt");
		getJseMarshaller().marshall(out, assembly);
		out.close();
	}

	/* package */ static Object getAssembly() {
