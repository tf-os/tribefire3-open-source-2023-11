...
public class AsStringExpert implements QueryFunctionExpert<AsString> {

	public static final AsStringExpert INSTANCE = new AsStringExpert();

	private AsStringExpert() {
	}

	@Override
	public Object evaluate(Tuple tuple, AsString queryFunction, Map<Object, Value> operandMappings, QueryEvaluationContext context) {
