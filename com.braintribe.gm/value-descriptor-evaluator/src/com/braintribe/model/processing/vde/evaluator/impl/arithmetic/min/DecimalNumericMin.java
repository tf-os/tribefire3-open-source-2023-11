 ...
 * 
 */
public class DecimalNumericMin implements ArithmeticEvalExpert<Number, Number> {

	private static DecimalNumericMin instance = null;

	protected DecimalNumericMin() {
		// empty
	}

	public static DecimalNumericMin getInstance() {
		if (instance == null) {
			instance = new DecimalNumericMin();
		}
		return instance;
	}
