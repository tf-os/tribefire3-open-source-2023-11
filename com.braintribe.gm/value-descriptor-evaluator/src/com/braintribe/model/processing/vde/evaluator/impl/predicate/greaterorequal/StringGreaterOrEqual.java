 ...
 * 
 */
public class StringGreaterOrEqual implements PredicateEvalExpert<String, String> {

	private static StringGreaterOrEqual instance = null;

	protected StringGreaterOrEqual() {
		// empty
	}

	public static StringGreaterOrEqual getInstance() {
		if (instance == null) {
			instance = new StringGreaterOrEqual();
		}
		return instance;
	}
