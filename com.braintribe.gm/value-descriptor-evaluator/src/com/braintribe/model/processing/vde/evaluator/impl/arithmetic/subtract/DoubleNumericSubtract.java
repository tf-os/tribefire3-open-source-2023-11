 ...
 * 
 */
public class DoubleNumericSubtract implements ArithmeticEvalExpert<Number, Number> {

	private static DoubleNumericSubtract instance = null;

	protected DoubleNumericSubtract() {
		// empty
	}

	public static DoubleNumericSubtract getInstance() {
		if (instance == null) {
			instance = new DoubleNumericSubtract();
		}
		return instance;
	}
