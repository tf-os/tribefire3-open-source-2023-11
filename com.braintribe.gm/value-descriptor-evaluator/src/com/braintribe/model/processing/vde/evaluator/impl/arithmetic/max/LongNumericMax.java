 ...
 * 
 */
public class LongNumericMax implements ArithmeticEvalExpert<Number, Number> {

	private static LongNumericMax instance = null;

	protected LongNumericMax() {
		// empty
	}

	public static LongNumericMax getInstance() {
		if (instance == null) {
			instance = new LongNumericMax();
		}
		return instance;
	}
