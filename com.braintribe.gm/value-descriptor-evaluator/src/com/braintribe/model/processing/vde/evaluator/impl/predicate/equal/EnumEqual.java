 ...
 * 
 */
public class EnumEqual implements PredicateEvalExpert<Enum<?>,Enum<?>>{

	private static EnumEqual instance = null;

	protected EnumEqual() {
		// empty
	}

	public static EnumEqual getInstance() {
		if (instance == null) {
			instance = new EnumEqual();
		}
		return instance;
	}
