 ...
 * 
 */
public class ObjectInstanceOfString implements PredicateEvalExpert<Object, String> {

	private static ObjectInstanceOfString instance = null;

	protected ObjectInstanceOfString() {
		// empty
	}

	public static ObjectInstanceOfString getInstance() {
		if (instance == null) {
			instance = new ObjectInstanceOfString();
		}
		return instance;
	}
