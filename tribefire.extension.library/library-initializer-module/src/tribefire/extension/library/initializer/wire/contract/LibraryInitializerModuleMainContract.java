...
public interface LibraryInitializerModuleMainContract extends WireSpace {

	LibraryInitializerModuleContract initializer();

	LibraryInitializerModuleModelsContract models();
