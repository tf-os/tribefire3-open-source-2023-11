...
@Abstract
public interface MetricsNotificationRequest extends MetricsRequest {

	EntityType<MetricsNotificationRequest> T = EntityTypes.T(MetricsNotificationRequest.class);

	@Override
	EvalContext<? extends MetricsNotificationResult> eval(Evaluator<ServiceRequest> evaluator);
