...
/**
 * Metrics Demo Processor
 * 
 *
 */
public interface MetricsDemoProcessor extends ServiceProcessor {

	final EntityType<MetricsDemoProcessor> T = EntityTypes.T(MetricsDemoProcessor.class);
