...
// ============================================================================
package tribefire.extension.metrics.initializer.wire.contract;
...
public interface ExistingInstancesContract extends WireSpace {
	...
	@GlobalId(MetricsConstants.MODULE_GLOBAL_ID)
	Module module();
	...
	@GlobalId("model:" + MetricsConstants.DEPLOYMENT_MODEL_QUALIFIEDNAME)
	GmMetaModel deploymentModel();

	@GlobalId("model:" + MetricsConstants.SERVICE_MODEL_QUALIFIEDNAME)
