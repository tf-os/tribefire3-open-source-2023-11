...
public class DerivedXsdTest extends AbstractXsdMarshallerTest {
	private File simple = new File( contents, "derived");
	private File input = new File( simple, "input");
	private File output = new File( simple, "output");
	
	private File in = new File( input, "derived.xsd");
	private File out = new File( output, "derived.xsd");
