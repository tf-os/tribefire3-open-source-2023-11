...
public class SingleAnyXsdTest extends AbstractXsdMarshallerTest {
	...
	private File in = new File( input, "any.single.xsd");
	private File out = new File( output, "any.single.xsd");
