...
public class IdXsdTest extends AbstractXsdMarshallerTest {
	private File simple = new File( contents, "id");
	private File input = new File( simple, "input");
	private File output = new File( simple, "output");
	
	private File in = new File( input, "id.xsd");
	private File out = new File( output, "id.xsd");
