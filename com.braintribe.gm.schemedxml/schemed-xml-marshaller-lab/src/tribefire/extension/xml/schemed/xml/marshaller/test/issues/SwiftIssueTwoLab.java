...
public class SwiftIssueTwoLab extends AbstractXmlMarshallerLab {
	private static final String TEST_XML = "swiftIssue.2.xml";
	private static final String TEST_XSD = "swiftIssue.2.xsd";
	private static final String TEST_MAPPING_MODEL_XML = "com.braintribe.xsd.swift.issue.two.SwiftIssueTwoFlatModel-mapping.model.xml";
	private File contents = new File(res, "issues");
	private File simple = new File( contents, "swiftIssue.2");
