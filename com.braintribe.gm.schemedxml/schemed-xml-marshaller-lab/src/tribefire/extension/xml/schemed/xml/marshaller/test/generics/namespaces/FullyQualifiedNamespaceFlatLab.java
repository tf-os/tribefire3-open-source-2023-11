...
public class FullyQualifiedNamespaceFlatLab extends AbstractXmlMarshallerLab {
	private static final String XML = "full.qualified.xml";	
	private static final String XSD = "full.qualified.xsd";
	private static final String MAPPING_MODEL_XML = "com.braintribe.xsd.QualifiedNamespaceFlatModel-mapping.model.xml";
