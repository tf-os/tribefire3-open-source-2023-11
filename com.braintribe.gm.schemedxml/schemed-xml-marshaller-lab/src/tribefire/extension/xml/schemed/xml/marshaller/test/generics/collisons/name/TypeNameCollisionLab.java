...
public class TypeNameCollisionLab extends AbstractXmlMarshallerLab {
	private static final String INPUT_XML = "typeclash.xml";
	private static final String INPUT_XSD = "typeclash.xsd";
	private static final String INPUT_MAPPING_MODEL_XML = "com.braintribe.xsd.TypeClashFlatModel-mapping.model.xml";
	private File contents = new File(res, "generics");
	private File simple = new File( contents, "nameclashes/flat");
