...
// ============================================================================
package tribefire.extension.xml.schemed.xml.marshaller.test.generics.bidirectional;
...
public class DuplicateBidirectionalLab extends AbstractXmlMarshallerLab {
	private static final String INPUT_XML = "link.2.xml";
	private static final String INPUT_XSD = "link.2.xsd";
	private static final String INPUT_MAPPING_MODEL_XML = "com.braintribe.xsd.BidiDuplicateFlatModel-mapping.model.xml";
	private File contents = new File(res, "generics");
	private File simple = new File( contents, "bidirectional/duplicate");
