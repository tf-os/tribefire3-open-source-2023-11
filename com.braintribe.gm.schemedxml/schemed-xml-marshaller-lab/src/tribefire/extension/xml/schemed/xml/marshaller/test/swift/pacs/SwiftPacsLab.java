...
// ============================================================================
package tribefire.extension.xml.schemed.xml.marshaller.test.swift.pacs;
...
public class SwiftPacsLab extends AbstractXmlMarshallerLab {
	private static final String TEST_XML = "pacs.008.01.01.a.xml";
	private static final String TEST_XSD = "pacs.008.001.01.ISO.xsd";
	private static final String MAPPING_MODEL_XML = "com.braintribe.xsd.swift.PacsFlattenedModel-mapping.model.xml";
	private File contents = new File(res, "swift");
	private File simple = new File( contents, "pacs/flat");
