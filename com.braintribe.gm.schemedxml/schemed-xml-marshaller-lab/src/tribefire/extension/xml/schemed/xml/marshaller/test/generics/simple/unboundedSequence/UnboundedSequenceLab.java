...
// ============================================================================
package tribefire.extension.xml.schemed.xml.marshaller.test.generics.simple.unboundedSequence;
...
public class UnboundedSequenceLab extends AbstractXmlMarshallerLab {
	private static final String VALIDATION_XSD = "simple.xsd";
	private static final String INPUT_XML = "unboundSequence.xml";
	private static final String COM_BRAINTRIBE_XSD_MAPPING_MODEL_XML = "com.braintribe.xsd.UnboundSequenceFlatModel-mapping.model.xml";
	private File contents = new File(res, "generics");
	private File simple = new File( contents, "unboundedSequence/flat");
	...
	public void test() {
		try {
			SchemedXmlMarshallerUnmarshallRequest umRequest = buildRequest(input, INPUT_XML, COM_BRAINTRIBE_XSD_MAPPING_MODEL_XML);
			SchemedXmlMarshallerUnmarshallResponse umResponse = process( umRequest);
			GenericEntity result = umResponse.getAssembly();
			System.out.println(result);
			
			SchemedXmlMarshallerMarshallRequest mRequest = buildRequest(input, result, COM_BRAINTRIBE_XSD_MAPPING_MODEL_XML);
			...
			File xsdInputFile = new File( input, VALIDATION_XSD);
