...
// ============================================================================
package tribefire.extension.xml.schemed.xml.marshaller.test.generics.simple.restriction;
...
public class SimpleRestrictionLab extends AbstractXmlMarshallerLab {
	private static final String SIMPLE_XML = "simple.xml";
	private static final String COM_BRAINTRIBE_XSD_SIMPLE_FLAT_MODEL_MAPPING_MODEL_XML = "com.braintribe.xsd.SimpleRestrictionFlatModel-mapping.model.xml";
	private File contents = new File(res, "generics");
	private File simple = new File( contents, "simpleRestriction/flat");
