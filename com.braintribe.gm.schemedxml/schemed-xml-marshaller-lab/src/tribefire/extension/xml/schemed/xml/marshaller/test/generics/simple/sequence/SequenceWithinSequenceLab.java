...
public class SequenceWithinSequenceLab extends AbstractXmlMarshallerLab {
	private static final String INPUT_XML = "sequences.1.xml";
	private static final String INPUT_XSD = "sequences.1.xsd";
	private static final String INPUT_MAPPING_MODEL_XML = "com.braintribe.xsd.SequencesNestedFlatModel-mapping.model.xml";
	private File contents = new File(res, "generics");
	private File simple = new File( contents, "sequences/flat");
