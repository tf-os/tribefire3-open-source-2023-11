...
public class UnQualifiedNamespaceFlatLab extends AbstractXmlMarshallerLab {
	private static final String XML = "unqualified.xml";	
	private static final String XSD = "unqualified.xsd";
	private static final String MAPPING_MODEL_XML = "com.braintribe.xsd.UnqualifiedNamespaceFlatModel-mapping.model.xml";
