...
public class UniqueBidirectionalLab extends AbstractXmlMarshallerLab {
	private static final String INPUT_XML = "link.1.xml";
	private static final String INPUT_XSD = "link.1.xsd";
	private static final String INPUT_MAPPING_MODEL_XML = "com.braintribe.xsd.BidiUniqueFlatModel-mapping.model.xml";
	private File contents = new File(res, "generics");
	private File simple = new File( contents, "bidirectional/unique");
