...
// ============================================================================
package tribefire.extension.xml.schemed.xml.marshaller.test.generics.simple.typeimport.redefining;
...
public class RedefiningTypeImportLab extends AbstractXmlMarshallerLab {
	private static final String SIMPLE_XML = "redefiningTypeImport.xml";
	private static final String COM_BRAINTRIBE_XSD_SIMPLE_FLAT_MODEL_MAPPING_MODEL_XML = "com.braintribe.xsd.RedefiningTypeImportFlatModel-mapping.model.xml";
	private File contents = new File(res, "generics");
	private File simple = new File( contents, "redefiningTypeImport/flat");
