...
// ============================================================================
package tribefire.extension.xml.schemed.xml.marshaller.test.overrides.collections;
...
public class OverrideCollectionsLab extends AbstractXmlMarshallerLab {
	private static final String XML = "overrideName.xml";
	private static final String XSD = "overrideName.xsd";
	private static final String MODEL_XML = "com.braintribe.xsd.OverrideCollectionModel-mapping.model.xml";
	private File contents = new File(res, "generics");
	private File simple = new File( contents, "overrides/collections/flat");
