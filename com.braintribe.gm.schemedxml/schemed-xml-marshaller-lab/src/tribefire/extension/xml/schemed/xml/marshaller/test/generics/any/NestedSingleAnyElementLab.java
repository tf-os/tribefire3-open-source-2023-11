...
// ============================================================================
package tribefire.extension.xml.schemed.xml.marshaller.test.generics.any;
...
public class NestedSingleAnyElementLab extends AbstractXmlMarshallerLab {
	private static final String INPUT_XML = "any.nested.single2.xml";
	private static final String INPUT_XSD = "any.single.xsd";
	private static final String INPUT_MAPPING_MODEL_XML = "com.braintribe.xsd.AnySingleFlatModel-mapping.model.xml";
	private File contents = new File(res, "generics");
	private File simple = new File( contents, "any/single");
