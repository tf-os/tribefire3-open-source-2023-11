...
public class NoNamespaceFlatLab extends AbstractXmlMarshallerLab {
	private static final String XML = "no.namespace.xml";	
	private static final String XSD = "no.namespace.xsd";
	private static final String MAPPING_MODEL_XML = "com.braintribe.xsd.NoNamespaceFlatModel-mapping.model.xml";
