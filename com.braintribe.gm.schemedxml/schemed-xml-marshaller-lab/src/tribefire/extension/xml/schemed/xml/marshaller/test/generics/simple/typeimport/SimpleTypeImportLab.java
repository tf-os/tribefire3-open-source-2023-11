...
// ============================================================================
package tribefire.extension.xml.schemed.xml.marshaller.test.generics.simple.typeimport;
...
public class SimpleTypeImportLab extends AbstractXmlMarshallerLab {
	private static final String SIMPLE_XML = "imported.xml";
	private static final String COM_BRAINTRIBE_XSD_SIMPLE_FLAT_MODEL_MAPPING_MODEL_XML = "com.braintribe.xsd.SimpleTypeImportFlatModel-mapping.model.xml";
	private File contents = new File(res, "generics");
	private File simple = new File( contents, "simpleTypeImport/flat");
