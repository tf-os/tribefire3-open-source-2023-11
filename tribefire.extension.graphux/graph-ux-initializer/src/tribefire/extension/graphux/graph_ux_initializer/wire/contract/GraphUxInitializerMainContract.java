...
public interface GraphUxInitializerMainContract extends WireSpace {

	GraphUxInitializerContract initializer();

	GraphUxInitializerModelsContract models();
	...
	tribefire.extension.simple.initializer.wire.contract.ExistingInstancesContract simpleExistingInstances();
