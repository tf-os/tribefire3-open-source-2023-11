...
// ============================================================================
package tribefire.extension.graphux.graph_ux_initializer.wire;
...
public enum GraphUxInitializerWireModule implements WireTerminalModule<GraphUxInitializerMainContract> {
	...
	public List<WireModule> dependencies() {
		return list(
				CoreInstancesWireModule.INSTANCE,
				SimpleInitializerWireModule.INSTANCE);
	}
}
