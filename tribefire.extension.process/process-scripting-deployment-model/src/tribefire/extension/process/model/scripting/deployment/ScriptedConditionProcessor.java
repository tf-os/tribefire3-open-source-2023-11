...
public interface ScriptedConditionProcessor extends HasScript, ConditionProcessor {

	EntityType<ScriptedConditionProcessor> T = EntityTypes.T(ScriptedConditionProcessor.class);
