...
public class StaticConditionProcessor<S extends Process> implements ConditionProcessor<S> {

	private boolean matches = false;
	
	public StaticConditionProcessor() {
	}
	
	public StaticConditionProcessor(boolean matches) {
	...
	@Override
	public boolean matches(ConditionProcessorContext<S> context) {
		return matches;
	}
