...
public interface StandardNodeEditor extends NodeEditor {
	@Override
	StandardNode element();
	
	@Override
	List<? extends StandardNode> elements();
	
	void addOnLeft(TransitionProcessor transitionProcessor);
}
