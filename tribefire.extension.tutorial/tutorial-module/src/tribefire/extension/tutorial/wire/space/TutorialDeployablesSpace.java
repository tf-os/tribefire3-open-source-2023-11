...
import tribefire.extension.tutorial.processing.LetterCaseTransformProcessor;

@Managed
public class TutorialDeployablesSpace implements WireSpace {
	
	@Managed //Methods with this annotation represent a Wire instance. They are enhanced on the byte-code level
