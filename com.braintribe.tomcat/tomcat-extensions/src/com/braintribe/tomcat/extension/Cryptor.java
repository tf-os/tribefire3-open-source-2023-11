...
/**
 * Note: this is a replica of the com.braintribe.utils.encryption.Cryptor class in platform-api.
 */
public class Cryptor {
	...
	public static String decrypt(String secret, String algorithm, String keyFactoryAlgorithm, Integer keyLength, String contentEncryptedAndEncoded)
			throws Exception {
		if (secret == null) {
			secret = "c36e99ec-e108-11e8-9f32-f2801f1b9fd1";
		}
		if (algorithm == null) {
	...
	public static String encrypt(String secret, String algorithm, String keyFactoryAlgorithm, Integer keyLength, String value) throws Exception {
		if (secret == null) {
			secret = "c36e99ec-e108-11e8-9f32-f2801f1b9fd1";
		}
		if (algorithm == null) {
