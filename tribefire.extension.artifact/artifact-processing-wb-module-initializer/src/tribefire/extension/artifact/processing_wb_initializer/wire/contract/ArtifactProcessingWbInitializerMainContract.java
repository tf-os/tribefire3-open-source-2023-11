...
public interface ArtifactProcessingWbInitializerMainContract extends WireSpace {

		
	DefaultWbContract workbenchContract();
	
	ArtifactProcessingWbInitializerContract artifactProcessingWbInitializerContract();
}
