...
public interface ArtifactProcessingInitializerMainContract extends WireSpace {

	ArtifactProcessingInitializerContract artifactProcessingInitializerContract();
