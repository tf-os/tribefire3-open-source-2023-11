...
// ============================================================================
package com.braintribe.model.access.smood.distributed.test.config;
...
public class Configurator {
	...
	protected WireContext<DistributedSmoodAccessTestContract> context;
	...
	public void initialize() throws Exception {
		try {
			...
			context = Wire
					.context(DistributedSmoodAccessTestContract.class)
					.bindContracts("com.braintribe.model.access.smood.distributed.test.wire")
					.build();
	...
	public DistributedSmoodAccessTestContract getConfiguration() {
