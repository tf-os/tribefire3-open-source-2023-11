...
public interface ShiroServiceProcessor extends AccessRequestProcessor {

	final EntityType<ShiroServiceProcessor> T = EntityTypes.T(ShiroServiceProcessor.class);
