...
public interface UpdateSession extends ShiroRequest {

	EntityType<UpdateSession> T = EntityTypes.T(UpdateSession.class);
	...
	@Override
	EvalContext<? extends ShiroResult> eval(Evaluator<ServiceRequest> evaluator);
