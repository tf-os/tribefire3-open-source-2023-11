...
/**
 * A {@link GmEntityTypeAspect} aspect. This aspect is added to the context automatically when the entity class (or
 * signature) is specified.
 */
public class GmEntityTypeAspect extends StaticScopedAspect<GmEntityType> {
	// blank
}
