...
public interface ModelOracle {
	...
	@JsMethod(name = "findGmTypeViaModelType")
	...
	@JsMethod(name = "getEntityTypeOracleViaGmEntityType")
	EntityTypeOracle getEntityTypeOracle(GmEntityType type);

	/** Same as {@link #getTypeOracle(CustomType)}. */
	@JsMethod(name = "getEntityTypeOracleViaEntityType")
	...
	/** Same as {@link #getTypeOracle(GmCustomType)}. */
	@JsMethod(name = "getEnumTypeOracleViaGmEnumType")
	...
	@JsMethod(name = "findTypeOracleViaCustomType")
	...
	@JsMethod(name = "findTypeOracleViaGmCustomType")
	...
	@JsMethod(name = "findEntityTypeOracleViaGmEntityType")
	EntityTypeOracle findEntityTypeOracle(GmEntityType type);

	/** Same as {@link #findTypeOracle(CustomType)}. */
	@JsMethod(name = "findEntityTypeOracleViaEntityType")
	...
	/** Same as {@link #findTypeOracle(GmCustomType)}. */
	@JsMethod(name = "findEnumTypeOracleViaGmEnumType")
