...
/**
 * Represents use case, which describes why the meta data is being resolved.
 * 
 * {@link UseCaseSelector}
 */
public class UseCaseAspect extends VolatileScopedAspect<Set<String>> {
	// blank
}
