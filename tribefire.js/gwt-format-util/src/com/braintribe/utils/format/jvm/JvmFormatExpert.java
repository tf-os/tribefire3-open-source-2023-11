...
public class JvmFormatExpert implements FormatExpert {

	private final static CustomDateFormat dateFormat = new JvmDateFormat();
	private final static CustomNumberFormat numberFormat = new JvmNumberFormat();
