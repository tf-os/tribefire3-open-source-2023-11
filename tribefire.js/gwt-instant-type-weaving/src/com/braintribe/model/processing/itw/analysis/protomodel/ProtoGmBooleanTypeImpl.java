 ...
 * @author peter.gazdik
 */
public class ProtoGmBooleanTypeImpl extends ProtoGmSimpleTypeImpl implements ProtoGmBooleanType {

	public ProtoGmBooleanTypeImpl() {
		setTypeSignature("boolean");
		setGlobalId("type:boolean");
	}
