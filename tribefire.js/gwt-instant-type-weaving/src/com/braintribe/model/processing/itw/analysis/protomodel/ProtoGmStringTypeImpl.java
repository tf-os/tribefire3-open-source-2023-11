 ...
 * @author peter.gazdik
 */
public class ProtoGmStringTypeImpl extends ProtoGmSimpleTypeImpl implements ProtoGmStringType {

	public ProtoGmStringTypeImpl() {
		setTypeSignature("string");
		setGlobalId("type:string");
	}
