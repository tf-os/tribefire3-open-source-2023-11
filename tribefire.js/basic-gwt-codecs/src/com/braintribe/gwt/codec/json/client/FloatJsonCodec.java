...
public class FloatJsonCodec implements Codec<Float, JSONValue> {
	@Override
	public JSONValue encode(Float value) throws CodecException {
		if (value == null) return JSONNull.getInstance();
		else return new JSONNumber(value);
	}
	
	@Override
	public Float decode(JSONValue jsonValue) throws CodecException {
		if (jsonValue == null || jsonValue.isNull() != null) return null;
			...
			return (float)integerValue.doubleValue();
		}
	}
