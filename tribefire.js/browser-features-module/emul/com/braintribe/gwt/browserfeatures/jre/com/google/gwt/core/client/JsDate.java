 ...
 */
@JsType(namespace = JsAnnotationsPackageNames.VIEW)
...
public class JsDate extends JavaScriptObject {
   ...
   */
  @JsMethod (name = "createByMilliseconds")
   ...
   */
  @JsMethod (name = "createByYearAndMonth")
   ...
   * Creates a new date using the specified values.
   */
  @JsMethod (name = "createByYearMonthAndDay")
   ...
   * Creates a new date using the specified values.
   */
  @JsMethod (name = "createByYearMonthDayAndHour")
   ...
   * Creates a new date using the specified values.
   */
  @JsMethod (name = "createByYearMonthDayHourAndMinute")
  public static native JsDate create(int year, int month, int dayOfMonth, int hours,
      int minutes) /*-{
   ...
   * Creates a new date using the specified values.
   */
  @JsMethod (name = "createByYearMonthDayHourMinuteAndSecond")
  public static native JsDate create(int year, int month, int dayOfMonth, int hours,
   ...
   * Creates a new date using the specified values.
   */
  @JsMethod (name = "createByYearMonthDayHourMinuteSecondAndMilli")
  public static native JsDate create(int year, int month, int dayOfMonth, int hours,
   ...
   * adjusted date.
   */
  @JsMethod (name = "setFullYearByYearAndMonth")
   ...
   * the adjusted date.
   */
  @JsMethod (name = "setFullYearByYearMonthAndDay")
   ...
   * adjusted date.
   */
  @JsMethod (name = "setHoursByHourAndMinute")
   ...
   */
  @JsMethod (name = "setHoursByHourMinuteAndSecond")
   ...
   */
  @JsMethod (name = "setHoursByHourMinuteSecondAndMilli")
   ...
   * adjusted date.
   */
  @JsMethod (name = "setMinutesByMinuteAndSecond")
   ...
   * representation of the adjusted date.
   */
  @JsMethod (name = "setMinutesByMinuteSecondAndMilli")
   ...
   * adjusted date.
   */
  @JsMethod (name = "setMonthByMonthAndDay")
   ...
   * of the adjusted date.
   */
  @JsMethod (name = "setSecondsBySecondAndMilli")
   ...
   * the adjusted date.
   */
  @JsMethod (name = "setUTCFullYearByYearAndMonth")
   ...
   * representation of the adjusted date.
   */
  @JsMethod (name = "setUTCFullYearByYearMonthAndDay")
   ...
   * of the adjusted date.
   */
  @JsMethod (name = "setUTCHoursByHourAndMinute")
   ...
   * representation of the adjusted date.
   */
  @JsMethod (name = "setUTCHoursByHourMinuteAndSecond")
   ...
   */
  @JsMethod (name = "setUTCHoursByHourMinuteSecondAndMilli")
   ...
   * representation of the adjusted date.
   */
  @JsMethod (name = "setUTCMinutesByMinuteAndSecond")
   ...
   * millisecond representation of the adjusted date.
   */
  @JsMethod (name = "setUTCMinutesByMinuteSecondAndMilli")
   ...
   * the adjusted date.
   */
  @JsMethod (name = "setUTCMonthByMonthAndDay")
   ...
   * representation of the adjusted date.
   */
  @JsMethod (name = "setUTCSecondsAndMillis")
