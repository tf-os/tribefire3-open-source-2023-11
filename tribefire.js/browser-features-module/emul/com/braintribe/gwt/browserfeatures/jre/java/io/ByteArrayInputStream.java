...
public class ByteArrayInputStream extends InputStream {
    ...
    public ByteArrayInputStream(byte[] buf) {
    	this(); // ensuring only one constructor delegates to super
        this.mark = 0;
        this.buf = buf;
    ...
    // ensuring only one constructor delegates to super
    private ByteArrayInputStream() {
    	// avoiding error: Class 'ByteArrayInputStream' should have only one constructor delegating to the superclass since it is subclass of a a type with JsConstructor.
    }
