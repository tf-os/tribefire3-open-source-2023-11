...
public final class Character implements Comparable<Character>, Serializable {
  ...
  @JsMethod(name="codePointAtWithLimit")
  public static int codePointAt(char[] a, int index, int limit) {
    return codePointAt(new CharSequenceAdapter(a), index, limit);
  }

  @JsMethod(name="codePointAtSequence")
  ...
  @JsMethod(name="codePointBeforeWithStart")
  public static int codePointBefore(char[] a, int index, int start) {
    return codePointBefore(new CharSequenceAdapter(a), index, start);
  }

  @JsMethod(name="codePointBeforeSequence")
  ...
  @JsMethod(name="codePointCountSequence")
  ...
  @JsMethod(name="offsetByCodePointsSequence")
