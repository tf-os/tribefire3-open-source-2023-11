...
public interface SecurityService {
	...
	OpenUserSessionResponse openUserSession(OpenUserSession request) throws AuthenticationException;

	boolean isSessionValid(String sessionId) throws SecurityServiceException;

	boolean logout(String sessionId) throws SecurityServiceException;
