...
public class MpcEvaluatorContextImpl implements MpcEvaluatorContext {
	...
	private void initVdeContext() {
		this.vdeRegistryBuilder = VDE.extendedRegistry().withConcreteExpert(MpcElementValue.class, new MpcElementValueVde());
	...
	private MpcEvaluator<ModelPathCondition> findExpertFor(ModelPathCondition condition) throws MpcEvaluatorRuntimeException {
		...
		Class<?> currentConditionType = condition.entityType().getJavaType();
	 ...
	 * @return {@link MpcNestedConditionExpertScope} representing the scope
	 */
