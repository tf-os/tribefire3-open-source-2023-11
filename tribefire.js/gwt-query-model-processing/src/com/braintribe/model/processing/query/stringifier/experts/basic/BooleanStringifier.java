...
public class BooleanStringifier implements Stringifier<Boolean, StringifierContext> {
	@Override
	public String stringify(Boolean operand, StringifierContext context) throws QueryStringifierRuntimeException {
