...
public class DefaultStringifier implements Stringifier<Object, StringifierContext> {
	@Override
	public String stringify(Object operand, StringifierContext context) throws QueryStringifierRuntimeException {
