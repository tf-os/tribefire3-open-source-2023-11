...
public class ConditionBuilder<T> extends AbstractOperandBuilder<T, ValueComparisonBuilder<T>, Condition> {
	...
	private static Negation newNegation(Condition condition) {
	...
	public ValueComparisonBuilder<T> entitySignature(String alias, String propertyPath) {
		...
		EntitySignature signatureFunction = EntitySignature.T.create();
	...
	private static Concatenation newConcatenation(List<Object> operandList) {
	...
	private static AsString newAsString(Object value) {
