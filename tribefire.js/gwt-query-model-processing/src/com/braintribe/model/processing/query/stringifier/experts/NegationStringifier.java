...
public class NegationStringifier implements Stringifier<Negation, BasicQueryStringifierContext> {
	@Override
	public String stringify(Negation negation, BasicQueryStringifierContext context) throws QueryStringifierRuntimeException {
		StringBuilder queryString = new StringBuilder();

		queryString.append("not ");
		context.stringifyAndAppend(negation.getOperand(), queryString);
