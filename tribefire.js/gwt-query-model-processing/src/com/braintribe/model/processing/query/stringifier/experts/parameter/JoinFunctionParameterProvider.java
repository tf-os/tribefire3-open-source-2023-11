...
public class JoinFunctionParameterProvider<F extends JoinFunction> implements SingleParameterProvider<F> {
	@Override
	public Object provideParameter(F function) {
		return function.getJoin();
	}
}
