...
public class RestrictionStringifier implements Stringifier<Restriction, BasicQueryStringifierContext> {
	@Override
	public String stringify(Restriction restriction, BasicQueryStringifierContext context) throws QueryStringifierRuntimeException {
		StringBuilder queryString = new StringBuilder();
		
		final Condition condition = restriction.getCondition();
		if (condition != null) {
			// Stringify condition of Query
			queryString.append(" where ");
			context.stringifyAndAppend(condition, queryString);
		}
