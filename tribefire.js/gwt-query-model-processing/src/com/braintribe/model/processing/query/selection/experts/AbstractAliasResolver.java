...
public abstract class AbstractAliasResolver implements SelectionAliasResolver {
	
	protected SignatureExpert shortening;
	...
	protected String resolveTypeSignature(String typeSignature) {
		return (shortening == null) ? typeSignature : shortening.shorten(typeSignature);
	}
