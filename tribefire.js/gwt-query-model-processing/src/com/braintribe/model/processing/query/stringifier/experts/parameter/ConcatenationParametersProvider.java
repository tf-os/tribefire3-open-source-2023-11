...
public class ConcatenationParametersProvider implements MultipleParameterProvider<Concatenation> {
	@Override
	public Collection<?> provideParameters(Concatenation function) {
