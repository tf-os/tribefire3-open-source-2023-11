...
public class StaticArrayList<T> extends AbstractList<T> {
	...
	public Iterator<T> iterator() {
		return new StaticArrayListIterator<T>(array, offset, offset, terminatorIndex);
	}
	...
	public ListIterator<T> listIterator(int index) {
		return new StaticArrayListIterator<T>(array, offset, index + offset, terminatorIndex);
	}

	@Override
	public List<T> subList(int fromIndex, int toIndex) {
		return new StaticArrayList<T>(array, offset + fromIndex, toIndex - fromIndex, unmodifiable);
	}
