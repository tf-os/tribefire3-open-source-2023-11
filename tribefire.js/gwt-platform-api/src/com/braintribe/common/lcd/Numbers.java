...
public final class Numbers {
	...
	/* Constants for simple numbers such as -1, 0, 1, etc. are not really needed. The reason they have been added here
	 * were experiments with checks that complain about "magic numbers" (which makes sense in some cases, but not
	 * always) and the idea was to easily avoid those warnings by using the numbers here. However, the better approach
	 * probably is to (find a way to) disable the warnings for these simple numbers, since their meaning often is
	 * self-explaining (in the context they are used). */
