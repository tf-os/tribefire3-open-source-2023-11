...
public final class CustomEqualsCollectionTools {
	...
	/**
	 * Returns all the elements in the <code>collection</code> that equal the <code>searchedElement</code> (according to
	 * the specified <code>equalsCheck</code>). Depending on argument <code>removeElement</code>, the elements are also
	 * removed from the <code>collection</code>.
	 */
	...
	/**
	 * Returns <code>true</code>, if <code>collection2</code> is a <code>Collection</code> that contains exactly the
	 * same elements (according to the specified <code>equalsCheck</code>) with exactly the same cardinalities. Also
	 * returns <code>true</code>, if both collections are <code>null</code>.
	 */
