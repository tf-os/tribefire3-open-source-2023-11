...
public class Constants {
	...
	/**
	 * The <code>Boolean</code> <code>true</code> representing success. This can be used to improve code readability
	 * when a <code>Boolean</code> represents success or error.
	 *
	 * @see #ERROR
	 */
	...
	/**
	 * The <code>Boolean</code> <code>false</code> representing an error. This can be used to improve code readability
	 * when a <code>Boolean</code> represents success or error.
	 *
	 * @see #SUCCESS
	 */
	...
	/**
	 * The value <code>null</code> used to indicate that a status (i.e. {@link #SUCCESS} or {@link #ERROR}) is not known
	 * or that any status is fine. This can be used to improve code readability when a <code>Boolean</code> represents
	 * success or error.
	 */
	...
	/**
	 * UTF-8 encoding for java.io and java.lang (see
	 * <code>http://docs.oracle.com/javase/1.5.0/docs/guide/intl/encoding.doc.html</code>).
	 */
	public static final String ENCODING_UTF8 = "UTF8";

	/**
	 * UTF-8 encoding for java.nio (see
	 * <code>http://docs.oracle.com/javase/1.5.0/docs/guide/intl/encoding.doc.html</code>).
	 */
	public static final String ENCODING_UTF8_NIO = "UTF-8";

	/**
	 * The name of the system property which holds the path to the temporary files directory:
	 * {@value #SYSTEMPROPERTY_TEMP_DIR}
	 */
