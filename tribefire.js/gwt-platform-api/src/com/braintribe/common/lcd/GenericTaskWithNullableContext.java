...
/**
 * Generic interface that may be used for classes that perform tasks using a (nullable) context provided by the calling
 * classes. One purpose of this interface is to avoid creating undesirable dependencies.
 *
