...
/**
 * The service provided by this class is executed periodically with the purpose of cleaning some specified folders. A
 * configuration file allows the specification of the following properties
 *
 * -The time intervals between executions -The names of the folders -The regular expressions that are used for matching
 * the contained files -The time specifications which are used for comparison with the last modification time of files
 *
 *
 */
public class SimpleDirectoryCleaner implements GenericTask {
	...
	private List<CleanDirectorySpecs> cleanDirectorySpecList = new ArrayList<CleanDirectorySpecs>();
