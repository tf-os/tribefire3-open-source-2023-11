 ...
 * {@link com.braintribe.utils.lcd.CommonTools}.
 *
...
public final class CommonTools extends com.braintribe.utils.lcd.CommonTools {
	...
	/**
	 * Parses the passed string, casts the parsed value to the expected type and then returns it. This method can be
	 * used to parse Integer, Long, Float, Double, Boolean, Enum (and String) values from strings. One can e.g. use the
	 * method to parse parameter values.
	 *
	 * @param <T>
	 *            the expected type of the value.
	 * @param name
	 *            the name (or description) of the value, e.g. if the value to be parsed is a parameter value, the name
	 *            should be the parameter name. The name is optional though, since it's only used in error messages.
	 * @param valueAsString
	 *            the value to be parsed as string.
	 * @param valueIsMandatory
	 *            whether the value is mandatory or not. If the value is not set (i.e. <code>null</code>), the default
	 *            value is returned. If a mandatory value is not set and there is no default value, an exception is
	 *            thrown.
	 * @param defaultValue
	...
	/**
	 * Waits for the specified amount of time. Note that this method ignores {@link InterruptedException}s. Instead one
	 * can specify an optional <code>breakCondition</code> to cause the method to return early.
	 */
	...
	/**
	 * Creates a new {@link File} instance and using the specified <code>filepath</code>. The file must not exist yet.
	 * The file itself is also created (i.e. an empty file).
	 *
	 * @see #getFile(String, boolean, boolean, boolean, boolean)
	...
	/**
	 * Creates a new {@link File} instance using the specified <code>filepath</code>. The file must not exist yet. The
	...
	/**
	 * Creates a new {@link File} instance using the specified <code>filepath</code>. The file must be an existing
	 * directory.
	 *
	 * @see #getFile(String, boolean, boolean, boolean, boolean)
	 */
	...
	/**
	 * Creates a new {@link File} instance using the specified <code>filepath</code>. The file must be a directory. If
	 * it doesn't exist yet, it is created.
	 *
	 * @see #getFile(String, boolean, boolean, boolean, boolean)
	 */
	...
	/**
	 * Gets the {@link Enum#name() names} of the enum constants (in the order returned by
	 * {@link Class#getEnumConstants()} of the specified enum.
	 */
	...
	/**
	 * Gets the component type of the passed <code>array</code> and returns the corresponding wrapper type. If the
	 * component type is not primitive, the component type itself is returned. Otherwise the method returns the
	 * {@link PrimitivesTools#getWrapper(Class) wrapper} of the primitive type.
	 */
	...
	/**
	 * Returns a list containing the elements of the passed <code>array</code>. The method first determines the list
	 * element type (using {@link #getCollectionElementTypeForArrayComponentType(Object)}) and then just invokes
	 * {@link #arrayToList(Object, Class)}.
	 */
	...
	/**
	 * Returns a list containing the elements of the passed <code>array</code>. The <code>listElementType</code>
	...
	/**
	 * Returns the result of {@link #replaceFileSeparators(String, String)} with the {@link #FILE_SEPARATOR system
	 * dependent default separator}.
	 */
	 ...
	 * {@link #replaceFileSeparators(String, String) replacing all file separators} with <code>/</code> (since in Java
	 * that separator works in Windows as well).
	 */
	...
	/**
	 * Gets the resource name (as expected by {@link ClassLoader#getResource(String)}) for the specified class. For
	 * example, for class name <code>java.lang.Integer</code> the method returns <code>java/lang/Integer.class</code>.
	 *
	 ...
	 *             if the <code>provider</code> returns <code>null</code>.
	 */
	public static <I, E> E provide(final Function<I, E> provider, final I index)
			throws RuntimeException, UnexpectedNullPointerException {
		try {
	...
	/**
	 * Converts the passed array of bytes into a (lower case) hex string. This can be used to convert
	 * {@link MessageDigest} hashes (e.g. MD5 bytes to string).
	 */
	 ...
	 * 
	 * @param byteArray The byte array that should be converted to a String.
