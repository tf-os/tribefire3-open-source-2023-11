...
/**
 * This is a slight variation of a StringWriter. The problem with the StringWriter is that it allocates memory by
 * doubling it every time the buffer gets too small. This is a problem for large buffers. Hence, this Writer stores the
 * buffer in memory until it reaches a limit. After that, an external file will be used to store the buffer.
 *
