...
public class StringTools {
	 ...
	 *
	 * @return the new string where the first and last character have been removed or an empty string if the length of
	 *         the specified string was <code>&lt;= 1</code> or <code>null</code> if the passed string was
	 *         <code>null</code>.
	 */
	...
	/**
	 * Searches the <code>searchedString</code> in the passed <code>string</code> and returns the substring before the
	 * <code>searchedstring</code>. If <code>string</code> is <code>null</code>, <code>null</code> is returned. If
	 * <code>searchedString</code> is <code>null</code>, the empty string is returned. If <code>searchedString</code>
	 * cannot be found in <code>string</code>, the whole <code>string</code> is returned.
	 *
	...
	/**
	 * Searches the <code>searchedString</code> in the passed <code>string</code> and returns the substring after the
	 * <code>searchedstring</code>. If <code>string</code> is <code>null</code>, <code>null</code> is returned. If
	 * <code>searchedString</code> is <code>null</code>, the <code>string</code> is returned. If
	 * <code>searchedString</code> cannot be found in <code>string</code>, an empty string is returned.
	 *
	 * @param lastOccurrenceInsteadOfFirst
	 *            specifies whether to search for the first or the last occurrence.
	 */
	...
	/**
	 * Returns the substring of <code>string</code> between <code>leftSearchString</code> and
	 * <code>rightSearchString</code>. Arguments must not be <code>null</code>!
	 */
	...
	/**
	 * Returns the substring of <code>string</code> from <code>leftSearchString</code> to <code>rightSearchString</code>
	 * . Arguments must not be <code>null</code>! This works like {@link #getSubstringBetween(String, String, String)}
	 * except that search strings are included in the returned string.
	 */
	...
	/**
	 * Shortens a String by cutting something out in the middle and replacing it with a character.
	 * If the resulting text has to be smaller than 6 characters, only one filler char will be used.
	 * If the text has to be smaller than 8 characters, two filler chars will be used. In any other
	 * case, 3 filler chars will be used.
	 * 
	 * @param text The String that should be shortened
	 * @param maxTotalLength The maximum total length of the result (including the filler characters)
	 * @param fillChar The character to use to fill the gap
	...
	/**
	 * Returns the given {@code string}, shortened to the first {@code numberOfChars}, and with {@code appendedChar}
	 * appended 3 times.
	 *
	 * @param string
	 *            - String to be abbreviated
	...
	/**
	 * Gets the last characters of the passed <code>string</code>. If the passed <code>string</code> is
	 * <code>null</code>, <code>null</code> is returned. If <code>numberOfCharacters</code> is <code>&lt;=0</code>, an
	 * empty string is returned. If the <code>numberOfCharacters</code> exceeds the length of the <code>string</code>,
	 * the whole <code>string</code> is returned.
	 */
	...
	/**
	 * Removes the last characters from the passed <code>string</code> and returns the new string. If the passed
	 * <code>string</code> is <code>null</code>, <code>null</code> is returned. If <code>numberOfCharacters</code> is
	 * <code>&lt;=0</code>, the whole <code>string</code> is returned. If the <code>numberOfCharacters</code> exceeds
	 * the length of the <code>string</code>, an empty string is returned.
	 */
	...
	/** Returns the prefix of given text up until the first occurrence of given boundary, including the boundary. If no boundary is found, empty string is returned. */
	...
	public static String removePrefixIfEligible(String text, String maybePrefix) {
		return text.startsWith(maybePrefix) ? removeSuffix(text, maybePrefix) : text;
	}
	...
	/**
	 * Gets the the specified number of characters of a string starting from <code>startIndex</code>. If the passed
	 * <code>string</code> is <code>null</code>, <code>null</code> is returned. If the <code>startIndex</code> exceeds
	 * the length of the string, an empty string is returned. If the <code>string</code> is not long enough to return as
	 * many characters as specified, less characters are returned.
	 */
	...
	/**
	 * Truncates the passed <code>string</code> if it's longer then the specified maximum length. If the passed string
	...
	/**
	 * Returns a new string where the substring from index <code>startIndex</code> (inclusive) to index
	 * <code>endIndex</code> (exclusive) is replaced by the <code>replacement</code> string which may have any length.
	 */
	...
	/**
	 * Replaces all white space in the passes <code>string</code> with the specified <code>replacementString</code> and
	 * returns the result.
	 */
	 ...
	 * @param searchedString
	 *            the searched string (which must not be null).
	 * @return the first string in the passed string collection that contains the specified searched string (or
	 *         <code>null</code> if the searched string is not found).
	 */
	...
	/**
	 * Splits the passed <code>string</code> once, i.e. at the first occurrence of the <code>delimiter</code>, which is
	 * NOT handled as a regular expression.
	 */
	...
	/**
	 * Behaves like {@link String#split(String, int)} (with second argument set to <code>-1</code>) except that the
	 * <code>delimiter</code> is not handled as a regular expression.
	 */
	...
	/**
	 * E.g. for "ThisIsCamelCase" returns ["This", "Is", "Camel", "Case"].
	 */
	...
	/**
	 * Replaces all but the last occurrence of <code>searchedString</code> in the passed <code>string</code> with the
	 * specified <code>replacementString</code> and returns the result. Arguments must not be <code>null</code>!
	 */
	...
	/**
	 * Invokes {@link #createStringFromCollection(Collection, String, Transformer)} with a transformer that uses the
	 * automatic Java string conversion.
	 */
	...
	/**
	 * Returns the result of {@link #createStringFromCollection(Collection, String, Transformer, Object)} with no
	...
	/**
	 * Creates a string containing the string representations of the elements in the passed <code>collection</code>
	 * separated by the specified <code>separator</code>.
	 *
	...
	/**
	 * Works like {@link #newStringBuilder(String...)} except that it gets the string representation of the
	 * <code>objects</code>.
	 */
	...
	/**
	 * Works like {@link #append(StringBuilder, String...)} except that it gets the string representation of the
	 * <code>objects</code>.
	 */
	// catch nullpointer instead of checking for null (performance)
	...
	/**
	 * Obfuscates the passord by replacing the characters with '*'. The beginning of the password is optionally shown
	 * (depending on the parameters).
	 *
	 * @param password
	 *            the password to obfuscate
	 * @param minimumObfuscatedCharacters
	 *            the minimum number of obfuscated passwords. If set to <code>&lt;0</code>, all characters will be
	 *            obfuscated.
	 * @param maximumDisplayedCharacters
	 *            the maximum number of displayed characters. If set to <code>&lt;0</code>, all characters may be
	 *            displayed (parameter <code>minimumObfuscatedCharacters</code> is stronger).
	...
	/**
	 * Convenience method to create a human-readable String representation of a time span. If the includeUnits is false,
	 * the method {@link #prettyPrintMilliseconds(long)} will be internally invoked. If includeUnits is set to true,
	 * this method will return the time span with time units included (using SI - International System of Units -
	 * standards). Note that only those parts are included in the resulting String that are greater than 0 (if, for
	 * example, the time span is 1 hour and 10 milliseconds, the result will not include 0 minutes).<br>
	...
	/**
	 * Returns the provided milliseconds in a more human-readable form. If 0 (zero) is provided, the return String will
	 * be "0". 1 will result in ".001", 1000 in "1.000", 60000 (1 minute) in "1:00.000", 86400000 (1 day) in
	 * "1:00:00:00.000". The maximum unit is 'days'.
	 *
	 * @param ms
	...
	/**
	 * Returns <code>true</code>, if the passed <code>string</code> {@link String#startsWith(String) starts with} any of
	 * the specified <code>prefixes</code>, otherwise <code>false</code>.
	 */
	...
	/**
	 * Splits the <code>string</code> using {@link Constants#SYSTEM_INDEPENDENT_LINE_SEPARATOR_REGEX line separator
	 * regex} and returns the individual lines.
	 */
	...
	/**
	 * Replaces {@link Constants#SYSTEM_INDEPENDENT_LINE_SEPARATOR_REGEX line separators} in the passed
	 * <code>string</code> with the specified <code>lineSeparator</code>.
	 *
	 * @throws IllegalArgumentException
	...
	/**
	 * Gets an array of Strings and returns the length of the longest String.
	 * If the array is null or empty, 0 will be returned.
	 * 
	...
	/**
	 * Tests whether the provided String is numeric or not.
	 * Note that any other character (e.g., a newline, a tab, etc) will cause this method to return false.
	 * 
	 ...
	 * @return <code>separator</code> delimited string representation of the provided array or <code>null</code>, if the
	 *         array is <code>null</code>. If there is a <code>null</code> value in the array, it is represented by a
	 *         <i>null</i> string.
	 */
	public static String createStringFromArray(final Object[] array, final String separator) {
		...
		for (int i = 0; i < array.length; ++i)
			sj.add(array[i] == null ? "null" : array[i].toString());

		return sj.toString();
	}

	/**
	 * Returns a string representation of the passed array. The whole array and each row are wrapped by '[' and ']'.
	 * Commas and line breaks are added after each row. The columns are comma separated as well.
	 *
	 * @param array
