...
/**
 * This class provides utility methods that can be used to conveniently check method arguments. Unless otherwise
 * mentioned the methods throw an {@link IllegalArgumentException}, if a check fails.
 *
...
public final class Arguments {
	...
	/**
	 * Returns the passed <code>object</code> or throws an {@link IllegalArgumentException} with the passed
	...
	/**
	 * Returns the passed <code>string</code> or throws an {@link IllegalArgumentException} with the passed
	 * <code>errorMessage</code>, if it is <code>null</code> or empty.
	 */
	...
	/**
	 * Returns the passed <code>collection</code> or throws an {@link IllegalArgumentException} with the passed
	 * <code>errorMessage</code>, if it is <code>null</code> or empty.
	 */
	...
	/**
	 * Returns the passed <code>map</code> or throws an {@link IllegalArgumentException} with the passed
	 * <code>errorMessage</code>, if it is <code>null</code> or empty.
	 */
	...
	/**
	 * Makes sure the specified argument is not <code>null</code>. If it is, an exception is thrown (and the exception
	 * message will include the name of the argument).
	 *
	...
	/**
	 * Makes sure the specified arguments are not <code>null</code>. If they are, an exception is thrown (and the
	 * exception message will include the names of the all arguments that are null).
	 *
	...
	public static void notNullWithNames(final Object... argumentNamesAndValues) {
		...
		final List<String> namesOfArgumentsThatAreNull = new ArrayList<String>();
		for (int i = 0; i < (argumentNamesAndValues.length - 1); i = i + 2) {
			if (argumentNamesAndValues[i + 1] == null) {
	...
	/**
	 * Makes sure the specified string arguments are not <code>null</code> or empty. If they are, an exception is thrown
	 * (and the exception message will include the names of the all arguments that are <code>null</code>/empty).
	 *
	 * @param argumentNamesAndValues
	 *            pairs of argument name/description and argument value.
	 */
