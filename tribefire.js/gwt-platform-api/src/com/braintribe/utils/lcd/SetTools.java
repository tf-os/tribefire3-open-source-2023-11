...
public class SetTools {
	...
	/**
	 * Adds the passed <code>elements</code> to the set. If the set already contains the element (or more precisely if
	 * an {@link Object#equals(Object) equal} element already exists), it is removed.
	 */
	 ...
	 *            the sets to merge
	 * @param idealSize
	 *            the ideal set size. If a set already exceeds that size, it won't be modified, i.e. no split! Empty
	 *            sets will be removed. If the size is negative, nothing will be merged. This method is a heuristic
	 *            approach, and therefore it does not provide the best set merging solution.
	 * @param duplicatesCheckEnabled
	 *            duplicates (i.e. elements contained in both sets). Since this check can be expensive, it can be
	 *            disabled
	 */
