...
public interface PathList extends List<String> {
	...
	default PathList pushFilePath(String elements) { return push(elements, File.separator); }
	default PathList pushSlashPath(String elements) { return push(elements, "/"); }
	default PathList pushBackSlashPath(String elements) { return push(elements, "\\"); }
	default PathList pushDottedPath(String elements) { return push(elements, "."); }
	...
	default PathList getParent() { return copy().pop(); }
	default PathList getNthParent(int n) { return copy().popN(n); }
	default PathList getChild(String element) { return copy().push(element); }
	default PathList getSibling(String element) { return copy().pop().push(element); }
