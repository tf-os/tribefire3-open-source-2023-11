 ...
 * {@link com.braintribe.utils.lcd.CollectionTools}.
 *
...
public final class CollectionTools extends com.braintribe.utils.lcd.CollectionTools {
	 ...
	 *            if <code>true</code>, elements that cannot be cast are just ignored. Otherwise an exception is thrown
	 *            if any element has the wrong type.
	 * @param skipNulls
	 *            if <code>true</code>, <code>null</code> elements will be skipped (i.e. not inserted in the
	 *            <code>targetCollection</code>).
	...
	/**
	 * Invokes {@link #addElementsToCollection(Collection, Collection, Class, boolean, boolean)} with <code>null</code>
	 * values not skipped.
	 */
	public static <C extends Collection<E>, E> C addElementsToCollection(final Collection<?> elements, final C targetCollection, final Class<E> clazz,
	...
	/**
	 * Throws a {@link ClassCastException} if any of the passed elements cannot be cast to the specified class.
	 * <code>null</code>s are allowed though!
	 */
	...
	/**
	 * Gets the first element from the passed <code>collection</code> that is an instance of the specified
	 * <code>searchedElementType</code>.
	 */
	...
	/**
	 * Gets all elements from the passed <code>collection</code> that are an instance of the specified
	 * <code>searchedElementType</code>. <code>null</code> values are skipped.
	 */
	...
	/**
	 * Gets the single element from the passed <code>collection</code> that is an instance of the specified
	 * <code>searchedElementType</code>.
	 *
	...
	/**
	 * Gets the element with the specified <code>index</code> from the passed <code>list</code>, unless the index is out
	 * of bounds (in which case the method returns <code>null</code>).
	 */
	...
	/**
	 * Splits a collection of elements into separate lists, each one having maximum element count defined by {@code batchSize}.
	 * If the source collection is empty, an empty list will be returned.
	 * 
	 * @param source The source collection.
	 * @param batchSize The maximum number of elements per list returned by this method.
	 * @return A list of lists of all the elements of the source collection.
	 * @throws NullPointerException Thrown if the source is null.
	 * @throws IllegalArgumentException Thrown if the batchSize is 0 or less.
	 */
