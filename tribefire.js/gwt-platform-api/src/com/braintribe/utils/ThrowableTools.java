 ...
 * {@link com.braintribe.utils.lcd.ThrowableTools}.
 *
...
public final class ThrowableTools extends com.braintribe.utils.lcd.ThrowableTools {
	...
	/**
	 * Recursively searches the <code>searchedCauseType</code> in the <code>Throwable</code> chain (i.e.
	...
	/**
	 * Gets a description of the passed <code>Exception</code> containing the exception class, message and stacktrace
	 * (only of the passed <code>throwable</code>, not of it's {@link Throwable#getCause() cause}.
	 *
	 * @param throwable
