...
public class ModelPath extends AbstractSequentialList<ModelPathElement> {
	...
	@Override
	@JsMethod(name="listIteratorIndex")
	...
	private enum Operation {none, iterate, add, remove}
	...
	/**
	 * converts a ModelPath into a {@link TraversingContext} stack which may come handy if one has a {@link TraversingCriterion}
	 * for a {@link StandardMatcher}
	 */
...
//			Object value = element.getValue();
	...
	/**
	 * converts a ModelPath into a {@link TraversingContext} which may come handy if one has a {@link TraversingCriterion}
	 * for a {@link StandardMatcher}
	 */
