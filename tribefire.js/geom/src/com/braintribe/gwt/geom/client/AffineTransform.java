...
public class AffineTransform {
    ...
    public Rect transform(Rect rect) {
    	return new Rect(transform(rect.getP1(), null), transform(rect.getP2(), null));
    }
    ...
    public Rect inverseTransform(Rect rect) throws  NoninvertibleTransformException {
    	Point p1 = inverseTransform(rect.getP1(), null); 
    	Point p2 = inverseTransform(rect.getP2(), null);
