...
abstract class CollectionTracker {
	...
	/**
	 * Note that if there is a {@link ClearCollectionManipulation}, it is always the first manipulation for given
	 * property, that is assured by the {@link SimpleManipulationNormalizer}.
	 */
	public abstract void onClearCollection();

	/**
	 * Note that if there is a {@link ChangeValueManipulation}, it is always the first manipulation for given property,
	 * that is assured by the {@link SimpleManipulationNormalizer}.
	 */
