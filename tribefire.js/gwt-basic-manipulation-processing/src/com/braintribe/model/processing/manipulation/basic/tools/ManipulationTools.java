...
public class ManipulationTools {
	...
	/**
	 * Combines all passed manipulations to a list and returns the result of {@link #asManipulation(List)} with this
	 * list passed. <br />
	 * All top-level {@link CompoundManipulation}s are flattened and only their direct elements are put to the
	 * list.<br />
	...
	/**
	 * Creates a new {@link EntityReference} based on an existing one with one of the identifying properties (id or
	 * partition) being changed. This is useful when processing manipulations and a {@link ChangeValueManipulation} on
	 * one of these properties is encountered.
	 */
