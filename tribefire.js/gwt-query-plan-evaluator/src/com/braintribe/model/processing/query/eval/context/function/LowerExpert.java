...
public class LowerExpert implements QueryFunctionExpert<Lower> {

	public static final LowerExpert INSTANCE = new LowerExpert();

	private LowerExpert() {
	}

	@Override
	public Object evaluate(Tuple tuple, Lower queryFunction, Map<Object, Value> operandMappings, QueryEvaluationContext context) {
		Object s = resolveOperandValue(context, tuple, operandMappings, queryFunction.getOperand());

		return s != null ? String.valueOf(s).toLowerCase() : null;
	}
