...
public class ConfigurableServiceRequestEvaluator implements Evaluator<ServiceRequest> {

	private static final Logger log = Logger.getLogger(ConfigurableServiceRequestEvaluator.class);
	...
	private class ServiceProcessorEvalContext<T> extends AbstractEvalContext<T> {
		...
		private ServiceRequestContext prepareContext() {
			...
			invocationContextBuilder.set(RequestEvaluationIdAspect.class, GMF.platform().newUuid());
