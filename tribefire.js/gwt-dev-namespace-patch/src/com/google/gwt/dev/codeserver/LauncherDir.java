...
class LauncherDir {
  ...
  static String generateStubNocacheJs(String outputModuleName, Options options) throws IOException {
    ...
    System.out.println("bindAddress " + bindAddress + " used instead of hostname");
    return template
        .replace("$wnd.location.hostname", bindAddress) //This is the actual change: using bindAddress here instead
