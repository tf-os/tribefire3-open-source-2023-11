 ...
 * 
 */
public class LongNumericSubtract implements ArithmeticEvalExpert<Number, Number> {

	private static LongNumericSubtract instance = null;

	protected LongNumericSubtract() {
		// empty
	}

	public static LongNumericSubtract getInstance() {
		if (instance == null) {
			instance = new LongNumericSubtract();
		}
		return instance;
	}
