 ...
 * 
 */
public class IntegerNumericSubtract implements ArithmeticEvalExpert<Number, Number> {

	private static IntegerNumericSubtract instance = null;

	protected IntegerNumericSubtract() {
		// empty
	}

	public static IntegerNumericSubtract getInstance() {
		if (instance == null) {
			instance = new IntegerNumericSubtract();
		}
		return instance;
	}
