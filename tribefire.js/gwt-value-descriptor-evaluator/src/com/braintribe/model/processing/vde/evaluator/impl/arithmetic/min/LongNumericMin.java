 ...
 * 
 */
public class LongNumericMin implements ArithmeticEvalExpert<Number, Number> {

	private static LongNumericMin instance = null;

	protected LongNumericMin() {
		// empty
	}

	public static LongNumericMin getInstance() {
		if (instance == null) {
			instance = new LongNumericMin();
		}
		return instance;
	}
