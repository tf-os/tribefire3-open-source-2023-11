 ...
 * 
 */
public class DateMinusTimeZoneOffset implements ArithmeticEvalExpert<Date, TimeZoneOffset> {

	private static DateMinusTimeZoneOffset instance = null;

	protected DateMinusTimeZoneOffset() {
		// empty
	}

	public static DateMinusTimeZoneOffset getInstance() {
		if (instance == null) {
			instance = new DateMinusTimeZoneOffset();
		}
		return instance;
	}
