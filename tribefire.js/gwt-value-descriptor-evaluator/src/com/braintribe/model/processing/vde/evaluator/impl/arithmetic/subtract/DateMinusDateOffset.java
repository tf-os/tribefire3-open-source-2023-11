 ...
 * 
 */
public class DateMinusDateOffset implements ArithmeticEvalExpert<Date, DateOffset> {

	private static DateMinusDateOffset instance = null;

	protected DateMinusDateOffset() {
		// empty
	}

	public static DateMinusDateOffset getInstance() {
		if (instance == null) {
			instance = new DateMinusDateOffset();
		}
		return instance;
	}
