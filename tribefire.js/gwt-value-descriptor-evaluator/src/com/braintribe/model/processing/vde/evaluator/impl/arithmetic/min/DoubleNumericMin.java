 ...
 * 
 */
public class DoubleNumericMin implements ArithmeticEvalExpert<Number, Number> {

	private static DoubleNumericMin instance = null;

	protected DoubleNumericMin() {
		// empty
	}

	public static DoubleNumericMin getInstance() {
		if (instance == null) {
			instance = new DoubleNumericMin();
		}
		return instance;
	}
