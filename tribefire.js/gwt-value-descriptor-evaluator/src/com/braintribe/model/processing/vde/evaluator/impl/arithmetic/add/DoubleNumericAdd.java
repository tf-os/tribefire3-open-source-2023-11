 ...
 * 
 */
public class DoubleNumericAdd implements ArithmeticEvalExpert<Number, Number> {

	private static DoubleNumericAdd instance = null;

	protected DoubleNumericAdd() {
		// empty
	}

	public static DoubleNumericAdd getInstance() {
		if (instance == null) {
			instance = new DoubleNumericAdd();
		}
		return instance;
	}
