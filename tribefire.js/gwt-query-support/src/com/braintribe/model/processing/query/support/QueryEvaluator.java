...
public class QueryEvaluator {
	...
	public synchronized void setLocaleProvider(Supplier<String> localeProvider) {
		addQueryFunctionAspectProvider(LocaleQueryAspect.class, localeProvider);
	}

	public synchronized <T, A extends QueryFunctionAspect<? super T>> void addQueryFunctionAspectProvider(Class<A> aspect, Supplier<T> provider) {
