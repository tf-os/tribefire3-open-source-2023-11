...
public class PropertyExpert extends AbstractPomExpert implements HasPomTokens {
	...
	public static Pair<String,String> read(PomReadContext context, String tag, XMLStreamReader reader) throws XMLStreamException{
		return new Pair<String,String>( tag, extractString(context, reader));		
	}
