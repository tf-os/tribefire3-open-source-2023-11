...
public abstract class AbstractResolvingContextTest implements HasCommonFilesystemNode {
	...
	protected static final String COMMON_CONTEXT_DEFINITION_YAML = "common.context.definition.yaml";
	...
	{	
		Pair<File,File> pair = filesystemRoots("wired/transitive/context/filter");
		input = pair.first;
		output = pair.second;
