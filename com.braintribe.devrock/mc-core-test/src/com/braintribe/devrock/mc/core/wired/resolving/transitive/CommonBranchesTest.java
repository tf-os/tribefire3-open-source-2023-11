...
public class CommonBranchesTest extends AbstractTransitiveResolverTest {

	@Override
	protected File archiveInput() {
		return new File( input, "commonBranches.definition.txt");
	}
	...
	public void run() {		
		...
		validator.validateExpressive( new File ( input, "commonBranches.validation.txt"), resolution);
