...
/**
 * tests a resolving without any bias -> reverse test
 * @author pit
 *
 */
public class NoBiasTransitiveResolvingTest extends AbstractTransitiveResolverBiasTest {
	...
	public void test() {
		...
		validator.validateExpressive( new File( input, "noBias.validation.txt"), resolution);
