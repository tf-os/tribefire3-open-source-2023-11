...
public abstract class AbstractTransitiveResolverBiasTest implements LauncherTrait, HasCommonFilesystemNode {	
	protected File repo;
	protected File input;
	protected File output;
	
	{	
		Pair<File,File> pair = filesystemRoots("wired/transitive/bias");
		input = pair.first;
		output = pair.second;
	...
	protected RepoletContent defaultArchiveInput() {
		File file = new File( input, "default.repolet.content.txt");
		try {
