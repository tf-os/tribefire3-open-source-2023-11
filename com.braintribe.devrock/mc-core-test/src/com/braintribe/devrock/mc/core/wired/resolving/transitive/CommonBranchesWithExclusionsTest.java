...
public class CommonBranchesWithExclusionsTest extends AbstractTransitiveResolverTest {

	@Override
	protected File archiveInput() {
		return new File( input, "commonBranchesWithExclusions.definition.txt");
	}
	...
	public void run() {		
		...
		validator.validateExpressive( new File ( input, "commonBranchesWithExclusions.validation.txt"), resolution);
