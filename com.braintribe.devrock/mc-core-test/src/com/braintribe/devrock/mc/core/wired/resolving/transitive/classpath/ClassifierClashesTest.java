...
/**
 * tests that two different references to the same artifact with however differing classifiers lead two entries in the classpath,
 * i.e. that no clashing is detected
 * 
 * 
 * @author pit
 *
 */
public class ClassifierClashesTest extends AbstractClasspathResolvingTest {
	...
	public void testFailureReportingOnUnresolvedDependencies() {
		...
		AnalysisArtifactResolution resolution = run("com.braintribe.devrock.test:t#[1.0,1.1)", resolutionContext, "classifier-clashes");
