 ...
 *
 */
public class DownloadManagerLab implements HasCommonFilesystemNode {
	...
	{	
		Pair<File,File> pair = filesystemRoots("wired/transitive/download.lab");
		input = pair.first;
		output = pair.second;
	...
	//@Test 
	// deactivated test as this artifact doesn't exist anymore ... if required, find a matching verfsion of jinni
	public void runTestOnJinniSetup() {
		run("tribefire.extension.setup:jinni#2.0.2073", "core-dev");
	}
