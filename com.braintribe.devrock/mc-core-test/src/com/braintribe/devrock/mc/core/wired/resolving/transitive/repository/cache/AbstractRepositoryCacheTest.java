...
public abstract class AbstractRepositoryCacheTest implements HasCommonFilesystemNode {
	...
	{	
		Pair<File,File> pair = filesystemRoots("wired/transitive/repository/cache");
		input = pair.first;
		output = pair.second;
