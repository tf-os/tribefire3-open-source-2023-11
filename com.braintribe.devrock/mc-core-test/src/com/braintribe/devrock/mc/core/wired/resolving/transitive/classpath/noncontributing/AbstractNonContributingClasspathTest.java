...
public abstract class AbstractNonContributingClasspathTest implements LauncherTrait, HasCommonFilesystemNode {
	protected File repo;
	protected File input;
	protected File output;
	
	{	
		Pair<File,File> pair = filesystemRoots("wired/transitive/classpath/noncontributing");
		input = pair.first;
		output = pair.second;
