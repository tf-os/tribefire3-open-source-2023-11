...
/**
 * tests that unauthorized repository : any other code 
 *  
 * @author pit
 *
 */
public class RepositoryErroneousTest extends AbstractRepositoryConfigurationProbingTest {
	...
	public void testUnauthorizedAccess() {
		try {
			...
			validate( repositoryConfiguration, "failing-archive", RepositoryErroneous.T);
