...
/**
 * tests a simple setup with a referred dep-mgt section
 * 
 *  not expected to work and it doesn't
 * 
 * @author pit
 *
 */
public class ReferredDepMgtDependencyDeclarationResolutionTest extends AbstractDependencyManagementResolvingTest {

	@Override
	protected RepoletContent archiveInput() {	
		return loadInput( new File( input, "referred.declared.depmgt.dependency.definition.yaml"));
	}
	

	@Test
	public void runReferredDepMgtResolution() {
