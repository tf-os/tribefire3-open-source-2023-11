 ...
 *
 */
public class RepositoryUnauthorizedTest extends AbstractRepositoryConfigurationProbingTest {
	...
	public void testUnauthorizedAccess() {
		try {
			...
			validate( repositoryConfiguration, "failing-archive", RepositoryUnauthorized.T);
