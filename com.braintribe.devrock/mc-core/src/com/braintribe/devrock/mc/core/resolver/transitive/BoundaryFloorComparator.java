...
public class BoundaryFloorComparator implements Function<CompiledArtifactIdentification, BoundaryHit> {
	...
	public BoundaryHit apply(CompiledArtifactIdentification t) {
		return t == BuildRange.boundaryFloor ? BoundaryHit.open: BoundaryHit.none;
	}
