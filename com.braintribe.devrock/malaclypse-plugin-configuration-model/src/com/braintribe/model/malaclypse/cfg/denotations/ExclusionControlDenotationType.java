...
public interface ExclusionControlDenotationType extends GenericEntity{
	
	final EntityType<ExclusionControlDenotationType> T = EntityTypes.T(ExclusionControlDenotationType.class);
