...
public class UpdatePolicyDynamicLab extends AbstractUpdatePolicyLab {
	protected static File settings = new File( "res/updatePolicyLab/contents/settings.dynamic.xml");
