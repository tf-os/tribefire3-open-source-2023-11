...
public class UpdatePolicyIntervalLab extends AbstractUpdatePolicyLab {
	protected static File settings = new File( "res/updatePolicyLab/contents/settings.interval.xml");	
