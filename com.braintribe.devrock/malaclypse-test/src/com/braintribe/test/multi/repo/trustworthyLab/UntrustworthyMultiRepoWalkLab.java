 ...
 * 
 * this one tests a repo that we know is lying
 * 
 * @author pit
 *
 */
public class UntrustworthyMultiRepoWalkLab extends AbstractTrustworthyMultiRepoWalkLab {
	...
	private static File settings = new File( contents, "settings.untrustworthy.xml");
