...
public class ValidationByHashLab extends AbstractValidationByHashMultiRepoWalkLab{
	private static File contents = new File( "res/validationByHashLab/contents");
