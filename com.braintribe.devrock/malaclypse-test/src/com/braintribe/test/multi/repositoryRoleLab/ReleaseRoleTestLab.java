...
public class ReleaseRoleTestLab extends AbstractRepositoryRoleLab {
	protected static File settings = new File( "res/repositoryRoleLab/contents/settings.release.xml");
