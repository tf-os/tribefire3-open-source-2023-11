...
public abstract class AbstractBuildOrderLab extends AbstractWalkLab {
	private static LauncherShell launcherShell;
	private static File contents = new File( "res/buildOrderTest/contents");
	...
	public Collection<Solution> runTest(String terminalAsString, String [] expectedNames, ScopeKind scopeKind, WalkKind walkKind, boolean skipOptional, DependencyScope ... additionalScopes) {
		try {
			...
			Collection<Solution> result = test( "runBuilderOrderTest", terminal, walkDenotationType, expectedNames,1,0, false);
