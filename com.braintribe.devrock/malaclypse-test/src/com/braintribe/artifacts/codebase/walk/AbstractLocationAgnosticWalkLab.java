...
public abstract class AbstractLocationAgnosticWalkLab extends AbstractCodebaseAwareLab implements SpecialEnvironment{
	...
	protected static void runbefore() {
		try {
			...
			agnosticResolverFactory.setSourceRepositories(Collections.singletonList(sourceRepository));
			...
			walkerFactory = walkerFactory( agnosticResolverFactory);
