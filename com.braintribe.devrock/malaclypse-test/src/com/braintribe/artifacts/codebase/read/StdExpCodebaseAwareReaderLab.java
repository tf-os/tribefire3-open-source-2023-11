...
public class StdExpCodebaseAwareReaderLab extends AbstractCodebaseAwareReaderLab {
	...
	public static void runBefore() {		
		...
		targetGrpOneSubOne = new File( target, "com/braintribe/grpOne/subOne/A/1.0/pom.xml");
	
		setupCodebase( EXPANDED_STANDARD);
		runbefore( EXPANDED_STANDARD);
	}
