...
public class GrpFlatCodebaseAwareReaderLab extends AbstractCodebaseAwareReaderLab {
	...
	public static void runBefore() {		
		...
		targetGrpOneSubOne = new File( target, "com.braintribe.grpOne.subOne/1.0/A/pom.xml");
