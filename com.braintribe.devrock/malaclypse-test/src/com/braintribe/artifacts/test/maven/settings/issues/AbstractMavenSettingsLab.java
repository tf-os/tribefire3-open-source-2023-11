...
public abstract class AbstractMavenSettingsLab {	
	...
	protected static OverrideableVirtualEnvironment ove;
	
	//protected static File contents; 
	protected static File [] data;
	private static MavenSettingsExpertFactory mavenSettingsfactory;
	...
	protected static void runBefore() {
		...
		ove = new OverrideableVirtualEnvironment();
		...
		mavenSettingsfactory.setVirtualEnvironment( ove);
	...
	protected static MavenSettingsReader getReader() {
		return mavenSettingsfactory.getMavenSettingsReader();
	}
