 ...
 *
 */
public  class StandardMergingTest extends AbstractMergingTest implements Validator{
	...
	public boolean validate(Settings settings) {
		...
		repositories.add( createRepository("recessive.active", null, "http://localhost:8080/archiveB", "default", recessiveReleases, recessiveSnapshots));
		*/
