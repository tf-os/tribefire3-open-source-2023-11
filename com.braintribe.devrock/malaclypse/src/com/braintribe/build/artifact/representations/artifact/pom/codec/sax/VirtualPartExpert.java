...
import com.braintribe.xml.parser.experts.AbstractContentExpert;
...
public class VirtualPartExpert extends AbstractContentExpert implements ContentExpert {
	...
	public void endElement(ContentExpert parent, String uri, String localName, String qName) throws SAXException {
		...
		if (startOfPartType == -1)
			throw new SAXException("missing expected part type on <?part classifier:type payload ?> processing instruction");
