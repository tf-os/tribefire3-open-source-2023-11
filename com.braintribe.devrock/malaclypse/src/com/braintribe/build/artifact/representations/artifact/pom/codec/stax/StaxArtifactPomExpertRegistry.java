...
import com.braintribe.xml.stax.parser.experts.PropertyExpertFactory;
...
import com.braintribe.xml.stax.parser.experts.VirtualComplexEntityExpertFactory;
import com.braintribe.xml.stax.parser.registry.AbstractContentExpertRegistry;

public class StaxArtifactPomExpertRegistry extends AbstractContentExpertRegistry {

	public StaxArtifactPomExpertRegistry() {
		...
		// virtual part
		addExpertFactory("project/dependencies/dependency/?part", new com.braintribe.build.artifact.representations.artifact.pom.codec.stax.VirtualPartExpertFactory());
