...
import com.braintribe.xml.stagedstax.parser.experts.PropertyExpertFactory;
...
import com.braintribe.xml.stagedstax.parser.experts.VirtualComplexEntityExpertFactory;
import com.braintribe.xml.stagedstax.parser.registry.AbstractContentExpertRegistry;

public class StagedStaxArtifactPomExpertRegistry extends AbstractContentExpertRegistry {

	public StagedStaxArtifactPomExpertRegistry() {
		...
		// virtual part
		addExpertFactory("project/dependencies/dependency/?part", new com.braintribe.build.artifact.representations.artifact.pom.codec.stax.staged.VirtualPartExpertFactory());
