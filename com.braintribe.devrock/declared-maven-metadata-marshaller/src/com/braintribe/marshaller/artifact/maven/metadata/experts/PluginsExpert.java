...
public class PluginsExpert extends AbstractMavenMetaDataExpert implements HasTokens {
	...
	public static List<Plugin> extract( MavenMetadataReadContext context, XMLStreamReader reader) throws XMLStreamException {
		...
		while (reader.hasNext()) {
			switch (reader.getEventType()) {
				case XMLStreamConstants.START_ELEMENT : {	
					...
					switch (tag) {
					case tag_plugin:
						plugins.add( PluginExpert.extract( context, reader));
					}
					break;
				}
