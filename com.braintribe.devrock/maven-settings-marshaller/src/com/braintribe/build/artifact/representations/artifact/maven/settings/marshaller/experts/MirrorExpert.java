...
public class MirrorExpert extends AbstractSettingsExpert {


	public static Mirror read(SettingsMarshallerContext context, XMLStreamReader reader) throws XMLStreamException {
		Mirror result = Mirror.T.create();
		reader.next();
				...
				case XMLStreamConstants.START_ELEMENT : {	
					...
					switch (tag) {
						...
						case URL:
							...
							break;
						case MIRROR_OF:
							result.setMirrorOf(extractString(context, reader));
							break;
						case NAME:
