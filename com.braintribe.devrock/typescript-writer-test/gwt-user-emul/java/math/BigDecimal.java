...
public class BigDecimal extends Number implements Comparable<BigDecimal>,
   ...
   *         10^(-{@code unscaledVal}).
   */
  @JsMethod(name="valueOfLongWithScale")
   ...
   */
  @JsMethod(name="divideWithRoundingMode")
   ...
   */
  @JsMethod(name="divideWithScaleAndRoundingMode")
   ...
   *           and rounding is necessary according to the given scale.
   */
  @JsMethod(name="setScaleWithRoundingMode")
