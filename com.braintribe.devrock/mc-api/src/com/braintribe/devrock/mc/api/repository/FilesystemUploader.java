...
public interface FilesystemUploader {
	ArtifactResolution upload(MavenFileSystemRepository repository, Artifact artifact);
	ArtifactResolution upload(MavenFileSystemRepository repository, Iterable<? extends Artifact> artifacts);
}
