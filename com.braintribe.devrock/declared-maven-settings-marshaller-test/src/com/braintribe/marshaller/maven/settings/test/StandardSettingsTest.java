...
public class StandardSettingsTest extends AbstractSettingsTest implements Validator {
	...
	public boolean validate(Settings settings) {
		...
		Property p_pa_ravenhurstUrlCustomAssets = createProperty("ravenhurst-url-custom-assets", "DEVROCK_TESTS_RAVENHURST_BASE_URL/custom-assets");
		...
		Property p_bt_ravenhurstUrlTP = createProperty("ravenhurst-url-third-party", "DEVROCK_TESTS_RAVENHURST_BASE_URL/third-party");
		
		Property p_bt_ravenhurstContextDR = createProperty("ravenhurst-context-devrock", "/");
		Property p_bt_ravenhurstUrlDR = createProperty("ravenhurst-url-devrock", "DEVROCK_TESTS_RAVENHURST_BASE_URL/devrock");
	
		Property p_bt_ravenhurstContextCD = createProperty("ravenhurst-context-core-dev", "/");
		Property p_bt_ravenhurstUrlCD = createProperty("ravenhurst-url-core-dev", "DEVROCK_TESTS_RAVENHURST_BASE_URL/core-dev");
