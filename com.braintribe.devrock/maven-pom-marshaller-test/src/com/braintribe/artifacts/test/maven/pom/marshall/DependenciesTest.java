 ...
 *
 */
public class DependenciesTest extends AbstractPomMarshallerTest {
	...
	public boolean validate(Solution solution) {
		...
		validateDependency( new BasicValidatorContext( dep1, groupId, "Dep1", "1.0"));
