...
/**
 * the contract for {@link RepositoryConfigurationLocator} providers
 * @author pit / dirk
 *
 */
public interface RepositoryConfigurationLocatorContract extends WireSpace {
	/**
	 * @return - a {@link RepositoryConfigurationLocator}
	 */
