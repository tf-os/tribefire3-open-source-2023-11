 ...
 */
public class MonthDayDatePicker extends Component implements HasValue<Date> {
   ...
   * applied when {@link MonthDayDatePicker#setDateTimeInfo(DatePickerDateTimeFormatInfo)} is called.
   */
   ...
   */
  public MonthDayDatePicker() {
	  this(new BlueDatePickerAppearance() {
			@Override
			public void renderMonthPicker(SafeHtmlBuilder sb, DatePickerMessages messages, String[] monthNames) {
				...
				for (int i = 0; i < 6; i++) {
					sb.appendHtmlConstant("<tr><td class='gxtReset " + style.month() + "'><a href=#>");
					sb.appendHtmlConstant(monthNames[i]);
					sb.appendHtmlConstant("</a></td>");
					sb.appendHtmlConstant("<td class='gxtReset " + style.month() + " " + style.monthSep() + "'><a href=#>");
				...
				sb.appendHtmlConstant("<tr class=" + style.monthButtons() + "><td class='gxtReset' colspan='4'>");
  ...
  public MonthDayDatePicker(DatePickerAppearance appearance) {
    ...
    addGestureRecognizer(new TapGestureRecognizer() {
      ...
      protected void onTap(TouchData touchData) {
        ...
        MonthDayDatePicker.this.onTap(touchData);
      }
    });
  }
   ...
   * {@link MonthDayDatePicker#setDateTimeInfo(DatePickerDateTimeFormatInfo)} is called.
   *
