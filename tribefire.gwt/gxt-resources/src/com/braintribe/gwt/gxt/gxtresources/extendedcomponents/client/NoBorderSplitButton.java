...
/**
 * {@link SplitButton} implementation without using a border when hovering.
 * @author michel.docouto
 *
 */
public class NoBorderSplitButton extends FixedSplitButton {
	
	public NoBorderSplitButton() {
		super();
		addStyleName(((WhiteButtonTableFrameResources) GWT.create(WhiteButtonTableFrameResources.class)).style().disabledStyle());
	}
	
	public NoBorderSplitButton(String text) {
		super(text);
		addStyleName(((WhiteButtonTableFrameResources) GWT.create(WhiteButtonTableFrameResources.class)).style().disabledStyle());
	}
