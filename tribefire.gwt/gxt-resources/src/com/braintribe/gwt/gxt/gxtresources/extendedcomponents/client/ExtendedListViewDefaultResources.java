...
public interface ExtendedListViewDefaultResources extends ListViewDefaultResources {
	
	public static final String GME_LIST_VIEW_ITEM = "gmeListViewItem";
	public static final String GME_LIST_VIEW_SEL = "gmeListViewSel";
	
	@Override
	@Source({"com/sencha/gxt/theme/base/client/listview/ListView.gss", "ExtendedListView.gss"})
