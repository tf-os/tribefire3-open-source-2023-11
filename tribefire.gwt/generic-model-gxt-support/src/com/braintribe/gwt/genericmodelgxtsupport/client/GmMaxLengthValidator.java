...
public class GmMaxLengthValidator extends MaxLengthValidator {
	...
	public GmMaxLengthValidator(int maxLength) {
		super(maxLength);
	}
	...
	public List<EditorError> validate(Editor<String> field, String value) {
	    ...
	    if (length > maxLength) {	    	
			...
			tip = prepareToolTip(getMessages().maxLengthText(maxLength));
			tip.showAtHoverElement();			
			return null;
