...
public class MappingFilterer implements RelationshipFilterer<MappingFilter>{
	
	@Override
	public boolean matches(CondensedRelationshipContext relationshipContext,
			RelationshipFiltererContext filtererContext,
			MappingFilter relationshipFilter) {
		return relationshipContext.getRelationship().getMapping();
	}
	
	@Override
	public boolean matches(Relationship relationship, RelationshipFiltererContext filtererContext, MappingFilter relationshipFilter) {
		return relationship.getRelationshipKind() == RelationshipKind.mapping;
	}
}
