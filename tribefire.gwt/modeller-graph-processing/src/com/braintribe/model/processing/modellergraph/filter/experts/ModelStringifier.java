...
public class ModelStringifier implements FilterStringifier<ModelFilter> {
	@Override
	public void stringify(FilterStringifyContext context, ModelFilter relationshipFilter, StringBuilder builder) {
		builder.append("model is " + relationshipFilter.getModel().getName());
	}
}
