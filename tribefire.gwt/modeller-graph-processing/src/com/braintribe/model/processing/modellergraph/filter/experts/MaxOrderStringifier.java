...
public class MaxOrderStringifier implements FilterStringifier<MaxOrderFilter> {
	@Override
	public void stringify(FilterStringifyContext context, MaxOrderFilter relationshipFilter, StringBuilder builder) {
		builder.append("order <= " + relationshipFilter.getMaxOrder());
	}
}
