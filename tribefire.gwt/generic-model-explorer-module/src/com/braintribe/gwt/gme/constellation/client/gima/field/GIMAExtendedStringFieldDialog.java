...
public class GIMAExtendedStringFieldDialog extends ExtendedStringFieldAceEditorDialog {

	private GIMAExtendedStringFieldView gimaView;
	...
	private GIMAExtendedStringFieldView prepareGIMAView(GIMADialog gimaDialog) {
		if (gimaView != null) {
		...
		gimaView = new GIMAExtendedStringFieldView(this, gimaDialog);
		return gimaView;
	}
