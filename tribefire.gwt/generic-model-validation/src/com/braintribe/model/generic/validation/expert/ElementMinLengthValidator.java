...
/**
 * Validate minimal length of a element inside the Collection, mostly of String
 * 
 */

public class ElementMinLengthValidator extends AbstractValidator<ElementMinLength> {

	@Override
	public Future<ValidatorResult> validateValue(ValidationContext validationContext, GenericEntity entity,
			ElementMinLength metadata, EntitySignatureAndPropertyName entitySignatureAndPropertyName, Object value) {
