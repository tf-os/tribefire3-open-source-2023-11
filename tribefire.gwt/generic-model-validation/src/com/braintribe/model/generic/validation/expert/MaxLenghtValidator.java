...
public class MaxLenghtValidator extends AbstractValidator<MaxLength> {

	@Override
	public Future<ValidatorResult> validateValue(ValidationContext validationContext, GenericEntity entity, MaxLength metadata,
