...
public interface EntityFieldDialog<E extends GenericEntity> {
	
	void setEntityValue(E entityValue);
	void setIsFreeInstantiation(Boolean isFreeInstantiation);
	...
	public default AbstractGridEditing<?> getParentGridEditing() {
		return null;
	}
