...
/**
 * Interface used for views which loads an external widget, and therefore waits for an external module to be available.
 *
 */
public interface GmExternalViewInitializationSupport {
