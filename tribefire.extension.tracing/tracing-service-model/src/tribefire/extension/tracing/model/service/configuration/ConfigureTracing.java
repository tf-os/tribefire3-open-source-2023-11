...
public interface ConfigureTracing extends MulticastTracingRequest {

	EntityType<ConfigureTracing> T = EntityTypes.T(ConfigureTracing.class);

	@Override
	EvalContext<? extends ConfigureTracingResult> eval(Evaluator<ServiceRequest> evaluator);
