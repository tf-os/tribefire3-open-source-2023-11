...
public interface EnableTracing extends MulticastTracingRequest {

	EntityType<EnableTracing> T = EntityTypes.T(EnableTracing.class);

	@Override
	EvalContext<? extends EnableTracingResult> eval(Evaluator<ServiceRequest> evaluator);
