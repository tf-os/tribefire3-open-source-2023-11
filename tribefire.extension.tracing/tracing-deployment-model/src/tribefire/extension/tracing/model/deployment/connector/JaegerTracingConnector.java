 ...
 *
 */
public interface JaegerTracingConnector extends TracingConnector {

	final EntityType<JaegerTracingConnector> T = EntityTypes.T(JaegerTracingConnector.class);

	String reporterConfiguration = "reporterConfiguration";
	String samplerConfiguration = "samplerConfiguration";
