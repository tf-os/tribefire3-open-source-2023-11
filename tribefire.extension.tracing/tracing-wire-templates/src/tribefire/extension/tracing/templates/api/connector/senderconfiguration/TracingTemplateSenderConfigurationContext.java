 ...
 *
 */
public interface TracingTemplateSenderConfigurationContext {

	static TracingTemplateSenderConfigurationContextBuilder builder() {
		throw new IllegalStateException("'" + TracingTemplateSenderConfigurationContextBuilder.class.getName()
