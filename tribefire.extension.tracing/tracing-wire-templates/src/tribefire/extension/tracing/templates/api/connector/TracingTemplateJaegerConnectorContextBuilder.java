 ...
 *
 */
public interface TracingTemplateJaegerConnectorContextBuilder extends TracingTemplateConnectorContextBuilder {

	TracingTemplateJaegerConnectorContextBuilder setReporterConfigurationContext(
			TracingTemplateReporterConfigurationContext reporterConfigurationContext);

	TracingTemplateJaegerConnectorContextBuilder setSamplerConfigurationContext(
			TracingTemplateSamplerConfigurationContext samplerConfigurationContext);

	@Override
	TracingTemplateJaegerConnectorContext build();
}