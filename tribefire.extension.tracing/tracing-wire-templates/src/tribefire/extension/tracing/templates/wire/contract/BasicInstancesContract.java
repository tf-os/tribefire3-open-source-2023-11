...
public interface BasicInstancesContract extends WireSpace {
	...
	IncrementalAccess workbenchAccess(TracingTemplateContext context);

	GmMetaModel essentialMetaDataModel(TracingTemplateContext context);

	GmMetaModel workbenchModel(TracingTemplateContext context);
