...
public interface OktaTemplatesContract extends WireSpace {

	void configure(OktaTemplateContext context);

	OktaAccess oktaAccess(OktaTemplateContext context);

	OktaAuthorizationPreProcessor authorizationPreProcessor(OktaTemplateContext context);

	OktaAuthorizationPreProcessor configuredAuthorizationPreProcessor(OktaTemplateContext context,
