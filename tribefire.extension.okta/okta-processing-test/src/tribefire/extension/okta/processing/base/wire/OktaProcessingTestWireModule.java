...
// ============================================================================
package tribefire.extension.okta.processing.base.wire;
...
public enum OktaProcessingTestWireModule implements WireTerminalModule<OktaProcessingTestContract> {
	INSTANCE;
