...
public class QueueListenerWorker extends AbstractListenerWorker {

	public QueueListenerWorker(EtcdMessaging providerConfiguration, MessagingContext messagingContext, Client client, KV kvClient, EtcdConnection etcdConnection) {
	...
	protected boolean acceptMessage(ReceivedMessageContext context, String myWorkerId) throws Exception {
		return connection.atomicLockAndDelete(context.getStringKey(), context.getModRevision(), myWorkerId, 60);
	}
