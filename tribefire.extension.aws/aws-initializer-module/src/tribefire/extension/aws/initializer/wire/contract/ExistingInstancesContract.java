...
public interface ExistingInstancesContract extends WireSpace {
	...
	@GlobalId("model:tribefire.extension.aws:aws-deployment-model")
	GmMetaModel deploymentModel();

	@GlobalId("model:tribefire.extension.aws:aws-service-model")
	GmMetaModel serviceModel();
	
	@GlobalId("model:tribefire.extension.aws:aws-model")
	GmMetaModel dataModel();
	
	@GlobalId(AwsConstants.MODULE_GLOBAL_ID)
