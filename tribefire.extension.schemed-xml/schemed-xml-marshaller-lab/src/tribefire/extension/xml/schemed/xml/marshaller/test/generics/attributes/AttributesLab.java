...
public class AttributesLab extends AbstractXmlMarshallerLab {
	private static final String INPUT_XML = "attributes.xml";
	private static final String INPUT_XSD = "attributes.xsd";
	private static final String INPUT_MAPPING_MODEL_XML = "com.braintribe.xsd.AttributesFlatModel-mapping.model.xml";
	private File contents = new File(res, "generics");
	private File simple = new File( contents, "attributes/flat");
