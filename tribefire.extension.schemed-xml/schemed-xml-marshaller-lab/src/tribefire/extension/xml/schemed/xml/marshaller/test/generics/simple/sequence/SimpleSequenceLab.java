...
// ============================================================================
package tribefire.extension.xml.schemed.xml.marshaller.test.generics.simple.sequence;
...
public class SimpleSequenceLab extends AbstractXmlMarshallerLab {
	private static final String INPUT_XML = "simpleSequence.xml";
	private static final String INPUT_XSD = "simpleSequence.xsd";
	private static final String INPUT_MAPPING_MODEL_XML = "com.braintribe.xsd.SimpleSequenceFlatModel-mapping.model.xml";
	private File contents = new File(res, "generics");
	private File simple = new File( contents, "simpleSequence/flat");
