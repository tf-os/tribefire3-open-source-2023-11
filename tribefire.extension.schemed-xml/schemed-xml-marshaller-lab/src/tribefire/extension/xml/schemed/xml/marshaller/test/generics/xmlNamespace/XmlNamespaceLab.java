...
// ============================================================================
package tribefire.extension.xml.schemed.xml.marshaller.test.generics.xmlNamespace;
...
public class XmlNamespaceLab extends AbstractXmlMarshallerLab {
	private static final String INPUT_XML = "xmlNamespace.xml";
	private static final String INPUT_XSD = "xmlNamespace.xsd";
	private static final String INPUT_MAPPING_MODEL_XML = "com.braintribe.xsd.XmlNamespaceFlatModel-mapping.model.xml";
	private File contents = new File(res, "generics");
	private File simple = new File( contents, "xmlNamespace/flat");
