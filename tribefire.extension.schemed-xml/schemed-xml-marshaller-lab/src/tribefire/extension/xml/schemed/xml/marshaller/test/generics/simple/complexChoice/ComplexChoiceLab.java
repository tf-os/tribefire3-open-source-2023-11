...
// ============================================================================
package tribefire.extension.xml.schemed.xml.marshaller.test.generics.simple.complexChoice;
...
public class ComplexChoiceLab extends AbstractXmlMarshallerLab {
	private static final String VALIDATION_XSD = "complex.xsd";
	private static final String INPUT_XML = "complexChoice.xml";
	private static final String COM_BRAINTRIBE_XSD_MAPPING_MODEL_XML = "com.braintribe.xsd.ComplexFlattenedModel-mapping.model.xml";
	private File contents = new File(res, "generics");
	private File simple = new File( contents, "complexChoice/flat");
