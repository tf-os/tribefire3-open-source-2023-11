...
// ============================================================================
package tribefire.extension.xml.schemed.xml.marshaller.test.generics.nestedQuali;
...
public class NestedQualificationLab extends AbstractXmlMarshallerLab {
	private static final String TEST_XML = "main.xml";
	private static final String TEST_XSD = "main.xsd";
	private static final String MAPPING_XML = "com.braintribe.xsd.NestedQualificationFlatModel-mapping.model.xml";
	private File contents = new File(res, "generics");
	private File simple = new File( contents, "nestedquali/flat");
	...
	public void test() {
		try {
			SchemedXmlMarshallerUnmarshallRequest umRequest = buildRequest(input, TEST_XML, MAPPING_XML);
			SchemedXmlMarshallerUnmarshallResponse umResponse = process( umRequest);
			GenericEntity result = umResponse.getAssembly();
			System.out.println(result);
			
			SchemedXmlMarshallerMarshallRequest mRequest = buildRequest(input, result, MAPPING_XML);
