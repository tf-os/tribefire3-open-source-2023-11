...
public class SimplestMultipleChoicesFlatLab extends AbstractXmlMarshallerLab {
	private static final String CHOICE_A_XML = "simplest.3.1.xml";
	private static final String CHOICE_B_XML = "simplest.3.2.xml";
	private static final String COM_BRAINTRIBE_XSD_SIMPLE_FLAT_MODEL_MAPPING_MODEL_XML = "com.braintribe.xsd.ReallySimplestMultipleChoiceFlatModel-mapping.model.xml";
	...
	private void test(String xml) {
		try {
			...
			File xsdInputFile = new File( input, "simplest.multiple.xsd");
