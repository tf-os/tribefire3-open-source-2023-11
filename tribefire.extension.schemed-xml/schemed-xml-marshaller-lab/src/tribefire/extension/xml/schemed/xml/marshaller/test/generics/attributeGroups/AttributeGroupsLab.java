...
// ============================================================================
package tribefire.extension.xml.schemed.xml.marshaller.test.generics.attributeGroups;
...
public class AttributeGroupsLab extends AbstractXmlMarshallerLab {
	private static final String INPUT_XML = "attributeGroup.xml";
	private static final String INPUT_XSD = "attributeGroup.xsd";
	private static final String INPUT_MAPPING_MODEL_XML = "com.braintribe.xsd.AttributeGroupFlatModel-mapping.model.xml";
	private File contents = new File(res, "generics");
	private File simple = new File( contents, "attributeGroups/flat");
