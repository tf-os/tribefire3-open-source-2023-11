...
public class SingleTypeAndPropertyNameCollisionLab extends AbstractXmlMarshallerLab {
	private static final String INPUT_XML = "typeAndAttributeClash3.xml";
	private static final String INPUT_XSD = "typeAndAttributeClash3.xsd";
	private static final String INPUT_MAPPING_MODEL_XML = "com.braintribe.xsd.SingleTypeAndAttrDivClashFlatModel-mapping.model.xml";
	private File contents = new File(res, "generics");
	private File simple = new File( contents, "nameclashes4/flat");
