...
public class SimpleStructuredLab extends AbstractXmlMarshallerLab {
	private static final String SIMPLE_XML = "simple.xml";
	private static final String COM_BRAINTRIBE_XSD_SIMPLE_FLAT_MODEL_MAPPING_MODEL_XML = "com.braintribe.xsd.SimpleStructuredModel-mapping.model.xml";
	private File contents = new File(res, "generics");
	private File simple = new File( contents, "simple/structured");
