...
public class MultipleAnyElementLab extends AbstractXmlMarshallerLab {
	private static final String INPUT_XML = "any.multiple.xml";
	private static final String INPUT_XSD = "any.multiple.xsd";
	private static final String INPUT_MAPPING_MODEL_XML = "com.braintribe.xsd.AnyMultipleFlatModel-mapping.model.xml";
	private File contents = new File(res, "generics");
	private File simple = new File( contents, "any/multiple");
