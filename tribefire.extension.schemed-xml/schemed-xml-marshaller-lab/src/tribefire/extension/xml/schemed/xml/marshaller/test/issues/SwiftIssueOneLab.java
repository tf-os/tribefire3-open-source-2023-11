...
public class SwiftIssueOneLab extends AbstractXmlMarshallerLab {
	private static final String TEST_XML = "swiftIssue.1.xml";
	private static final String TEST_XSD = "swiftIssue.1.xsd";
	private static final String TEST_MAPPING_MODEL_XML = "com.braintribe.xsd.swift.issue.one.SwiftIssueOneFlatModel-mapping.model.xml";
	private File contents = new File(res, "issues");
	private File simple = new File( contents, "swiftIssue.1");
