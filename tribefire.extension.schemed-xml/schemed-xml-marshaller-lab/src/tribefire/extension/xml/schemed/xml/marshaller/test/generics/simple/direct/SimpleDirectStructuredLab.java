...
// ============================================================================
package tribefire.extension.xml.schemed.xml.marshaller.test.generics.simple.direct;
...
public class SimpleDirectStructuredLab extends AbstractXmlMarshallerLab {
	private static final String SIMPLE_XML = "simple.xml";
	private static final String COM_BRAINTRIBE_XSD_SIMPLE_FLAT_MODEL_MAPPING_MODEL_XML = "com.braintribe.xsd.SimpleDirectFlatModel-mapping.model.xml";
	private File contents = new File(res, "generics");
	private File simple = new File( contents, "simpleDirect/flat");
	...
	public void test() {
		try {
			...
			File xsdInputFile = new File( input, "simpleDirect.xsd");
