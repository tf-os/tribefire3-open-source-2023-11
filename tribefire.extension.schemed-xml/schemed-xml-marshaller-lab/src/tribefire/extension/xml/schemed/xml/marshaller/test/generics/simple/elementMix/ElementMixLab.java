...
// ============================================================================
package tribefire.extension.xml.schemed.xml.marshaller.test.generics.simple.elementMix;
...
public class ElementMixLab extends AbstractXmlMarshallerLab {
	private static final String VALIDATION_XSD = "elementMix.xsd";
	private static final String INPUT_XML = "elementMix.xml";
	private static final String COM_BRAINTRIBE_XSD_MAPPING_MODEL_XML = "com.braintribe.xsd.ElementMixFlatModel-mapping.model.xml";
	private File contents = new File(res, "generics");
	private File simple = new File( contents, "elementMix/flat");
