...
public class SimpleXsdTest extends AbstractXsdMarshallerTest {
	private File simple = new File( contents, "simple");
	private File input = new File( simple, "input");
	private File output = new File( simple, "output");
	
	private File in = new File( input, "simple.xsd");
	private File out = new File( output, "simple.xsd");
