...
public class ChoiceXsdTest extends AbstractXsdMarshallerTest {
	private File simple = new File( contents, "choices");
	private File input = new File( simple, "input");
	private File output = new File( simple, "output");
	
	private File in = new File( input, "choices.xsd");
	private File out = new File( output, "choices.xsd");
