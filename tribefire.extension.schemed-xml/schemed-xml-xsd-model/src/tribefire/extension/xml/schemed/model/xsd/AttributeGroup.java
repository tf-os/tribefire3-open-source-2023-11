...
public interface AttributeGroup extends SchemaEntity, Annoted, SequenceAware, HasAttributes, HasAttributeGroups, HasName {
	
	final EntityType<AttributeGroup> T = EntityTypes.T(AttributeGroup.class);

	QName getRef();
	void setRef( QName group);
