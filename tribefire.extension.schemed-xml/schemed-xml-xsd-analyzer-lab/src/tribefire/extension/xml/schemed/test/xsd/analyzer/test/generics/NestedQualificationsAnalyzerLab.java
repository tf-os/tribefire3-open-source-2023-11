...
public class NestedQualificationsAnalyzerLab extends AbstractXsdAnalyzerLab {
	private static File simple = new File( contents, "nestedQualification");
	...
	public void flat_RedefiningTypeImport() {
		...
		refs.add( "import.xsd");
		SchemedXmlXsdAnalyzerRequest request = buildPrimerRequest( input, "com.braintribe.nested.quali", "main.xsd", refs, "com.braintribe.xsd:NestedQualificationFlatModel#1.0");		
