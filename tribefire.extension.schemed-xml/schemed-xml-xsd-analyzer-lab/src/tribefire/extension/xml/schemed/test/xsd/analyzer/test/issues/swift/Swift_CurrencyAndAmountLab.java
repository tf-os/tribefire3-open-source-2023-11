...
public class Swift_CurrencyAndAmountLab extends AbstractXsdAnalyzerLab {
	private static final String TEST_MODEL = "com.braintribe.xsd.swift.issue.two:SwiftIssueTwoFlatModel#1.0";
	private static final String TEST_XSD = "swiftIssue.2.xsd";
	private static String TEST_PACKAGE = "com.braintribe.xsd.swift.issue.two";	
	private static File simple = new File( contents, "issues/two");
