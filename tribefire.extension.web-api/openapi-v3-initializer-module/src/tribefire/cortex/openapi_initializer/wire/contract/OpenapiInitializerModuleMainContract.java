...
public interface OpenapiInitializerModuleMainContract extends WireSpace {

	OpenapiInitializerModuleContract initializer();

	OpenapiInitializerModuleModelsContract models();
