...
public interface WebApiServerInitializerMainContract extends WireSpace {

	WebApiServerInitializerContract initializer();

	WebApiServerInitializerModelsContract models();
