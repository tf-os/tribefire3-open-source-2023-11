...
public interface HttpUnmappedParam extends HttpParam {

	final EntityType<HttpUnmappedParam> T = EntityTypes.T(HttpUnmappedParam.class);

	@Override
	default HttpParamType paramType() {
		return HttpParamType.UNMAPPED;
	}
