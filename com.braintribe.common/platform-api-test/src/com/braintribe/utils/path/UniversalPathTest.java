...
// ============================================================================
package com.braintribe.utils.path;
...
public class UniversalPathTest {
	...
	public void testLongPath() {
		UniversalPath relativePath = UniversalPath.empty().push("name1").push("name2").push("name3").push("name4").push("name5").push("name6")
				.push("name7").push("name8").push("name9").push("name10"); // 10 times
