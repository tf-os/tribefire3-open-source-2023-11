...
public final class CompiledFormatter {
	...
	public String format(Object... args) throws Exception {
		return format(l, args);
	}
	 ...
	 *
	 * @param l
	 *            The {@linkplain java.util.Locale locale} to apply during formatting. If {@code l} is {@code null} then no localization is applied.
	 *            This does not change this object's locale that was set during construction.
	 *
	 * @param format
	 *            A format string as described in <a href="#syntax">Format string syntax</a>
	 *
	 * @param args
	 *            Arguments referenced by the format specifiers in the format string. If there are more arguments than format specifiers, the extra
	 *            arguments are ignored. The maximum number of arguments is limited by the maximum dimension of a Java array as defined by <cite>The
	 *            Java&trade; Virtual Machine Specification</cite>.
	 *
	 * @throws IllegalFormatException
	 *             If a format string contains an illegal syntax, a format specifier that is incompatible with the given arguments, insufficient
	 *             arguments given the format string, or other illegal conditions. For specification of all possible formatting errors, see the
	 *             <a href="#detail">Details</a> section of the formatter class specification.
	 *
	 * @throws FormatterClosedException
	 *             If this formatter has been closed by invoking its {@link #close()} method
	 *
	 ...
	 */
	public String format(Locale l, Object... args) throws Exception {
			...
			try {
				switch (index) {
					...
					case -1: // relative index
						...
						fs.print(sb, (args == null ? null : args[last]), l);
						break;
					case 0: // ordinary index
						...
						fs.print(sb, (args == null ? null : args[lasto]), l);
						break;
				...
				throw new Exception("Could not apply arguments on format " + this.format + ": " + args, x);
			}
		}
		return sb.toString();
	}
	...
	private interface FormatString {
		...
		void print(StringBuilder a, Object arg, Locale l) throws IOException;
	...
	private class FixedString implements FormatString {
		...
		@Override
		public void print(StringBuilder a, Object arg, Locale l) throws IOException {
			a.append(s);
		}
	...
	private class FormatSpecifier implements FormatString {
		...
		private void printInteger(StringBuilder a, Object arg, Locale l) throws IOException {
			if (arg == null) {
				print(a, "null");
		...
		private void printFloat(StringBuilder a, Object arg, Locale l) throws IOException {
			if (arg == null) {
				print(a, "null");
		...
		private void printDateTime(StringBuilder a, Object arg, Locale l) throws IOException {
			if (arg == null) {
				print(a, "null");
				return;
			}
		...
		private void printCharacter(StringBuilder a, Object arg) throws IOException {
			if (arg == null) {
				print(a, "null");
				return;
			}
		...
		private void printString(StringBuilder a, Object arg, Locale l) throws IOException {
			if (arg instanceof Formattable) {
				throw new IOException("Formattable not supported");
				/* Formatter fmt = Formatter.this; if (fmt.locale() != l) fmt = new Formatter(fmt.out(), l); ((Formattable)arg).formatTo(fmt,
				 * f.valueOf(), width, precision); */
			} else {
		...
		private void printBoolean(StringBuilder a, Object arg) throws IOException {
			String s;
			if (arg != null) {
		...
		private void printHashCode(StringBuilder a, Object arg) throws IOException {
