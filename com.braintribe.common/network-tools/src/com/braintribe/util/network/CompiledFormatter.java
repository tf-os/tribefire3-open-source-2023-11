...
final class CompiledFormatter {
	 ...
	 *
	 * <p>
	 * The {@link #format(java.util.Locale,String,Object...) format} method for this object which has a locale argument
	 ...
	 *
	 * @param l
	 *            The {@linkplain java.util.Locale locale} to apply during formatting. If {@code l} is {@code null} then
	 *            no localization is applied. This does not change this object's locale that was set during
	 *            construction.
	 *
	 * @param format
	...
	private class FormatSpecifier implements FormatString {
		...
		private void printString(StringBuilder a, Object arg, Locale l) throws IOException {
			if (arg instanceof Formattable) {
				...
				/* Formatter fmt = Formatter.this; if (fmt.locale() != l) fmt = new Formatter(fmt.out(), l);
