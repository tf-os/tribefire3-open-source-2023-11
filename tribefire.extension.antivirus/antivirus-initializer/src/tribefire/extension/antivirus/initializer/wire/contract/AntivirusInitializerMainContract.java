...
public interface AntivirusInitializerMainContract extends WireSpace {

	AntivirusInitializerContract initializer();

	ExistingInstancesContract existingInstances();

	CoreInstancesContract coreInstances();

	AntivirusTemplatesContract antivirusTemplate();
