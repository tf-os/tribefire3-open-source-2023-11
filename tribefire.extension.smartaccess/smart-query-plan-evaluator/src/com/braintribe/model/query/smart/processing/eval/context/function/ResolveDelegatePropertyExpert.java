 ...
 * 
 */
public class ResolveDelegatePropertyExpert implements QueryFunctionExpert<ResolveDelegateProperty> {

	public static final ResolveDelegatePropertyExpert INSTANCE = new ResolveDelegatePropertyExpert();

	private ResolveDelegatePropertyExpert() {
	}

	@Override
	public Object evaluate(Tuple tuple, ResolveDelegateProperty riFunction, Map<Object, Value> operandMappings,
