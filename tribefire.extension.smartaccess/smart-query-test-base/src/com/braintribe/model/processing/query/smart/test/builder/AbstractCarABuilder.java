 ...
 * 
 */
public abstract class AbstractCarABuilder<T extends CarA, B extends AbstractBuilder<T, B>> extends AbstractBuilder<T, B> {

	public AbstractCarABuilder(Class<T> clazz, RepositoryDriver repoDriver) {
