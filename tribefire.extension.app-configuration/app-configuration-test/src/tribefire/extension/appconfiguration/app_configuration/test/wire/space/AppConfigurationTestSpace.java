...
// ============================================================================
package tribefire.extension.appconfiguration.app_configuration.test.wire.space;
...
@Managed
public class AppConfigurationTestSpace implements AppConfigurationTestContract {
	...
	private void configureAccesses(@SuppressWarnings("unused") AccessProcessingConfiguration configuration) {
	...
	private void configureSecurity(@SuppressWarnings("unused") InMemorySecurityServiceProcessor bean) {
