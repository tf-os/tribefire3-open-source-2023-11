...
public interface AppConfigurationInitializerMainContract extends WireSpace {

	AppConfigurationInitializerContract initializer();

	AppConfigurationInitializerModelsContract models();
