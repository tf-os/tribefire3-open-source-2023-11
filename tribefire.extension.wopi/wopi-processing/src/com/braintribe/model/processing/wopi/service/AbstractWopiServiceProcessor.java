...
/**
 * Base for all WOPI service processors
 * 
 *
 */
public abstract class AbstractWopiServiceProcessor implements AbstractWopiProcessing {

	protected <T extends HasNotifications> ResponseBuilder<T> responseBuilder(EntityType<T> responseType, WopiRequest request) {
	...
	protected <T extends HasNotifications> T prepareSimpleNotification(EntityType<T> responseEntityType, WopiRequest request, Level level,
			String msg) {
