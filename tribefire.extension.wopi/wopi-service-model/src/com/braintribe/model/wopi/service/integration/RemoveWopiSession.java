...
/**
 * Remove a WOPI Session
 * 
 *
 */
public interface RemoveWopiSession extends WopiRequest {

	EntityType<RemoveWopiSession> T = EntityTypes.T(RemoveWopiSession.class);

	@Override
	EvalContext<? extends RemoveWopiSessionResult> eval(Evaluator<ServiceRequest> evaluator);
