 ...
 *
 */
public interface AddDemoDocsResult extends WopiResult {

	EntityType<AddDemoDocsResult> T = EntityTypes.T(AddDemoDocsResult.class);
	...
	@MinLength(9)
	@MaxLength(9)
	List<WopiSession> getWopiSessions();
	void setWopiSessions(List<WopiSession> wopiSessions);
