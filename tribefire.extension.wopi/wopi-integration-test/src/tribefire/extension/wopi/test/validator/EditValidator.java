...
/**
 * Executing Office Online validation from 'https://github.com/microsoft/wopi-validator-core' - EDIT
 * 
 *
 */
@Category(SpecialEnvironment.class)
public class EditValidator extends AbstractValidatorWopiTest {

	public EditValidator(String testGroup, String testName) {
	...
	public void setup() {
		...
		request.setDocumentMode(DocumentMode.edit);
