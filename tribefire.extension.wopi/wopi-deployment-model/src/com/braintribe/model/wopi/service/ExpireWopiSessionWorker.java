...
import static tribefire.extension.wopi.model.WopiMetaDataConstants.EXPIRE_INTERVAL_DESCRIPTION;
import static tribefire.extension.wopi.model.WopiMetaDataConstants.EXPIRE_INTERVAL_NAME;
...
/**
 * Sets WopiSession to expired is necessary
 * 
 *
 */
public interface ExpireWopiSessionWorker extends Worker {

	final EntityType<ExpireWopiSessionWorker> T = EntityTypes.T(ExpireWopiSessionWorker.class);
	...
	@Name(EXPIRE_INTERVAL_NAME)
	@Description(EXPIRE_INTERVAL_DESCRIPTION)
	@Mandatory
