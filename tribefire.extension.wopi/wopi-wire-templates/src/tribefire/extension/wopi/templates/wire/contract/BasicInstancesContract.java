...
public interface BasicInstancesContract extends WireSpace {
	...
	IncrementalAccess workbenchAccess(WopiTemplateContext context);

	GmMetaModel essentialMetaDataModel(WopiTemplateContext context);

	GmMetaModel workbenchModel(WopiTemplateContext context);
