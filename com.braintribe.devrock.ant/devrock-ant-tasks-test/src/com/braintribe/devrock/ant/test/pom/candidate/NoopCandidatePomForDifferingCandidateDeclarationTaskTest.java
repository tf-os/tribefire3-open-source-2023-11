 ...
 * 
 */
public class NoopCandidatePomForDifferingCandidateDeclarationTaskTest extends TaskRunner {
	...
	protected void preProcess() {
		...
		TestUtils.copy( new File(input, "pom.noop.candidate.rc.xml"), new File(output, "pom.xml"));
	}
	...
	public void runPomTasksTest() {
		...
		validator.validateString(versionedName, "com.braintribe.devrock.test:t#1.0.1-rc");		
