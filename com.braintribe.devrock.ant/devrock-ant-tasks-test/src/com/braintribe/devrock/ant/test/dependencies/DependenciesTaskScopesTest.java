...
/**
 * tests a simple dependencies-task on a pom with a single 'provided' dependency
 *  
 * @author pit
 *
 */
public class DependenciesTaskScopesTest extends TaskRunner implements ProcessNotificationListener {
	
	private List<String> result;

	@Override
	protected String filesystemRoot() {	
		return "dependencies.scopes";
	}
	...
	/**
	 * tests the default scope --> 'runtime', so provided gets kicked
	 */
	@Test
	public void runDefaultDependenciesTasks() {
		process( new File( output, "build.xml"), "dependenciesDefaultScope");
	...
	/**
	 * tests the 'compile' scope --> all must be present
	 */
	@Test
	public void runCompileDependenciesTasks() {
		process( new File( output, "build.xml"), "dependenciesCompile");
	...
	/**
	 * tests the 'runtime' scope --> nothing must present
	 */
	@Test
	public void runRuntimeDependenciesTasks() {
		process( new File( output, "build.xml"), "dependenciesRuntime");
