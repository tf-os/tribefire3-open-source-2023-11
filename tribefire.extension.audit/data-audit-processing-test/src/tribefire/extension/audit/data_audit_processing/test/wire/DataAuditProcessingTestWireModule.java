...
// ============================================================================
package tribefire.extension.audit.data_audit_processing.test.wire;
...
public enum DataAuditProcessingTestWireModule implements WireTerminalModule<DataAuditProcessingTestContract> {
	INSTANCE;
