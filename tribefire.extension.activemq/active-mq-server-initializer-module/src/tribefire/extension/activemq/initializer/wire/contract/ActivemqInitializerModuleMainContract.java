...
public interface ActivemqInitializerModuleMainContract extends WireSpace {

	ActivemqInitializerModuleContract initializer();

	ActivemqInitializerModuleModelsContract models();
