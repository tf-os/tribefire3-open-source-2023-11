...
@Managed
public class ActivemqInitializerModuleMainSpace implements ActivemqInitializerModuleMainContract {

	@Import
	private ActivemqInitializerModuleContract initializer;
	...
	@Override
	public ActivemqInitializerModuleContract initializer() {
		return initializer;
	}

	@Override
	public ActivemqInitializerModuleModelsContract models() {
		return models;
	}
