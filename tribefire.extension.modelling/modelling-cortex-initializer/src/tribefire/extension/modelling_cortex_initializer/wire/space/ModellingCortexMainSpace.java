...
@Managed
public class ModellingCortexMainSpace extends AbstractInitializerSpace implements ModellingCortexMainContract {

	@Import
	private ModellingCortexContract initializer;
	...
	@Override
	public ModellingCortexContract initializerContract() {
		return initializer;
	}

	@Override
	public ModellingCortexModelsContract initializerModelsContract() {
		return models;
	}
