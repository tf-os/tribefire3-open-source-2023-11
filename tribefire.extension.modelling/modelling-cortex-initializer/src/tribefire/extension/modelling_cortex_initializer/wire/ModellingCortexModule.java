...
// ============================================================================
package tribefire.extension.modelling_cortex_initializer.wire;
...
public enum ModellingCortexModule implements WireTerminalModule<ModellingCortexMainContract> {
	INSTANCE;
	
	@Override
	public Class<ModellingCortexMainContract> contract() {
		return ModellingCortexMainContract.class;
	}
