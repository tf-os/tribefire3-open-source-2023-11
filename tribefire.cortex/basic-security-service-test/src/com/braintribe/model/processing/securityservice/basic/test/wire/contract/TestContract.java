...
// ============================================================================
package com.braintribe.model.processing.securityservice.basic.test.wire.contract;
...
public interface TestContract extends WireSpace {
	...
	AccessDataInitializer dataInitializer();

	PersistenceGmSession authGmSession();

	PersistenceGmSession userSessionsGmSession();

	SecurityServiceProcessor securityServiceProcessor();

	Evaluator<ServiceRequest> requestEvaluator();
