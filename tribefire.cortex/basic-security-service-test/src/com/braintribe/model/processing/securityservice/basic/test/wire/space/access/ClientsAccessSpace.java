...
@Managed
public class ClientsAccessSpace extends SystemAccessSpaceBase {

	private static final String id = "clients";
	private static final String modelName = _DeploymentModel_.reflection.name();
