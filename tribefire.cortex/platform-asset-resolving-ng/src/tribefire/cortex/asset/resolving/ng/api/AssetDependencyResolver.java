...
public interface AssetDependencyResolver {
	...
	public PlatformAssetResolution resolve(AssetResolutionContext context, CompiledDependencyIdentification projectDependency, List<CompiledDependencyIdentification> setupDependencies);
}
