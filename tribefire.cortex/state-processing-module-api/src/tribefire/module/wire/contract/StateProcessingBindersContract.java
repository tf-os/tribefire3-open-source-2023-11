...
public interface StateProcessingBindersContract extends WireSpace {

	ComponentBinder<StateChangeProcessor, com.braintribe.model.processing.sp.api.StateChangeProcessor<?, ?>> stateChangeProcessor();
