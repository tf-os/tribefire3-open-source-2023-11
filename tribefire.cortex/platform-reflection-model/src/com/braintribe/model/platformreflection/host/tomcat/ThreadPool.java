...
public interface ThreadPool extends GenericEntity {
	...
	Integer getCurrentThreadCount();
	void setCurrentThreadCount(Integer currentThreadCount);
	
	Integer getMaxThreadCount();
	void setMaxThreadCount(Integer maxThreadCount);
	
	Integer getCurrentThreadsBusy();
	void setCurrentThreadsBusy(Integer currentThreadsBusy);
