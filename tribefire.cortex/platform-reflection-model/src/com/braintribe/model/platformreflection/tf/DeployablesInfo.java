...
public interface DeployablesInfo extends PlatformReflectionResponse {

	EntityType<DeployablesInfo> T = EntityTypes.T(DeployablesInfo.class);

	List<AccessInfo> getAccessInfos();
	void setAccessInfos(List<AccessInfo> accessInfos);

	List<DeployableInfo> getDeployableInfos();
	void setDeployableInfos(List<DeployableInfo> deployableInfos);
