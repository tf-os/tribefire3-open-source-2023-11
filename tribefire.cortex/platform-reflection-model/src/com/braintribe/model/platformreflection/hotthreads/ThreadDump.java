...
public interface ThreadDump extends PlatformReflectionResponse {

	EntityType<ThreadDump> T = EntityTypes.T(ThreadDump.class);
	
	String getThreadDump();
	void setThreadDump(String threadDump);
