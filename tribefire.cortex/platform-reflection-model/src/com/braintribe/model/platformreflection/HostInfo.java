...
public interface HostInfo extends PlatformReflectionResponse {

	EntityType<HostInfo> T = EntityTypes.T(HostInfo.class);
	
	void setHostHomePath(String hostHomePath);
	String getHostHomePath();
	
	void setHostType(String hostType);
	String getHostType();
	
	void setHostVersion(String hostVersion);
	String getHostVersion();
	
	void setWebapps(List<Webapp> webapps);
