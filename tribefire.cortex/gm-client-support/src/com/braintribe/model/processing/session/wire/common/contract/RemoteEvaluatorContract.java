...
// ============================================================================
package com.braintribe.model.processing.session.wire.common.contract;
...
public interface RemoteEvaluatorContract extends WireSpace {

	RemoteAuthentifyingInterceptor remotifyingInterceptor();
