...
// ============================================================================
package com.braintribe.model.platform.service;
...
public interface ExternalTribefireRequest extends AuthorizedRequest, GenericProcessingRequest, HasServiceRequest, PlatformRequest {

	final EntityType<ExternalTribefireRequest> T = EntityTypes.T(ExternalTribefireRequest.class);
