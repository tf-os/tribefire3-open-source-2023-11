...
public class TestRunnerRegistryImpl implements TestRunnerRegistry {

	List<ModuleTestRunner> testRunners = new ArrayList<>();

	@Override
	public List<ModuleTestRunner> getTestRunners() {
		return Collections.unmodifiableList(testRunners);
	}

	@Override
	public void register(ModuleTestRunner testRunner) {
