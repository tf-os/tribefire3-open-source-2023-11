...
// ============================================================================
package tribefire.cortex.qa_main.wire;
...
import tribefire.cortex.qa_main.wire.space.QaMainModuleSpace;
import tribefire.cortex.testing.junit.wire.JUnitTestingWireModule;

public enum QaMainModuleWireModule implements StandardTribefireModuleWireModule {

	INSTANCE;

	@Override
	public Class<? extends TribefireModuleContract> moduleSpaceClass() {
		return QaMainModuleSpace.class;
	}
