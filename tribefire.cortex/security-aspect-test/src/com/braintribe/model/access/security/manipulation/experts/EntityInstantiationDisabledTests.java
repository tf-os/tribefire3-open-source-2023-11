 ...
 * 
 */
public class EntityInstantiationDisabledTests extends ValidatorTestBase {

	@Override
	protected Set<? extends ManipulationSecurityExpert> manipulationSecurityExperts() {
		return asSet(new EntityInstantiationDisabledExpert());
	}

	@Test
	public void instantiationIfAllowedIsOk() throws Exception {
	...
	public void instantiationIfDisabledIsNotOk() throws Exception {
		validate(() -> session.create(EntityWithConstraints.T));
