...
public interface DynamicConfirmation extends Confirmation {
	
	EntityType<DynamicConfirmation> T = EntityTypes.T(DynamicConfirmation.class);
	
	void setRequestProcessing(RequestProcessing requestProcessing);
	RequestProcessing getRequestProcessing();
	
	void setMouseClick(ConfirmationMouseClick mouseClick);
	ConfirmationMouseClick getMouseClick();
