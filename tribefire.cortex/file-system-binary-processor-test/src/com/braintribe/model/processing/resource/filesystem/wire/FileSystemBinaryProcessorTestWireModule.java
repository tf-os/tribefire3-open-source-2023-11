...
// ============================================================================
package com.braintribe.model.processing.resource.filesystem.wire;
...
public enum FileSystemBinaryProcessorTestWireModule implements WireTerminalModule<MainContract> {
	INSTANCE;
