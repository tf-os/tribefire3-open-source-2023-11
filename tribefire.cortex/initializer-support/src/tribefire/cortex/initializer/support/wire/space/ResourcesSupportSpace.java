...
import tribefire.cortex.initializer.support.impl.ResourceMetaDataResolver;
 ...
 */
@Managed
public class ResourcesSupportSpace implements WireSpace {
	...
	public ResourceMetaDataResolver resourceMetaDataResolver() {
		ResourceMetaDataResolver bean = new ResourceMetaDataResolver();
		bean.setModuleResources(moduleResources);
		bean.setModuleName(moduleReflection.moduleName());
		bean.setYamlMarshaller(marshalling.registry().getMarshaller("text/yaml"));
