...
// ============================================================================
package tribefire.cortex.asset.resolving.test.wire.contract;
...
public interface AssetResolvingTestContract extends WireSpace {
	RepositoryConfigurationContract repositoryConfigurationContract();

	AssetDependencyResolver assetResolver();
}
