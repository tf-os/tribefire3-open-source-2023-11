...
@Managed
public class UserSessionsWorkbenchAccessSpace extends CollaborativeSystemAccessSpaceBase {

	public static final String id = UserSessionsAccessSpace.id + ".wb";
	public static final String name = UserSessionsAccessSpace.name + " Workbench";
	public static final TribefireProductModel model = TribefireProductModels.userSessionsWorkbenchAccessModel;
