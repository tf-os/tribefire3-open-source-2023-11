...
@Managed
public class TransientMessagingDataWorkbenchAccessSpace extends CollaborativeSystemAccessSpaceBase {

	public static final String id = TransientMessagingDataAccessSpace.id + ".wb";
	public static final String name = TransientMessagingDataAccessSpace.name + " Workbench";
	public static final TribefireProductModel model = TribefireProductModels.transientMessagingDataWorkbenchAccessModel;
