...
@Managed
public class PlatformSetupWorkbenchAccessSpace extends CollaborativeSystemAccessSpaceBase {

	private static final String id = "setup.wb";
	private static final String name = "Platform Setup Workbench";
	private static final TribefireProductModel model = TribefireProductModels.platformSetupWorkbenchAccessModel;
