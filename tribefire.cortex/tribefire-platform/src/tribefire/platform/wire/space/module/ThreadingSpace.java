 ...
 */
@Managed
public class ThreadingSpace implements ThreadingContract {

	@Import
	private CurrentUserAuthContextSpace currentUserAuthContext;

	@Override
	public DeferringThreadContextScoping contextScoping() {
		return currentUserAuthContext.threadContextScoping();
	}
