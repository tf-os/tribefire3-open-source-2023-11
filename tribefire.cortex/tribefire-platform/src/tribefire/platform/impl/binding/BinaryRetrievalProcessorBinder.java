...
public class BinaryRetrievalProcessorBinder extends AbstractServiceProcessorBinder<BinaryRetrieval, BinaryRetrievalRequest, BinaryRetrievalResponse> {

	@Override
	public EntityType<BinaryRetrieval> componentType() {
		return BinaryRetrieval.T;
	}
