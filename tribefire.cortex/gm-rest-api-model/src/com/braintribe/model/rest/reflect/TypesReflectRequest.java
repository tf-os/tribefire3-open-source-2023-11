...
public interface TypesReflectRequest extends RestRequest, HasProjection, HasCodec {

	EntityType<TypesReflectRequest> T = EntityTypes.T(TypesReflectRequest.class);
	
	void setSignature(String signature);
	String getSignature();
	void setAbstraction(String abstraction);
