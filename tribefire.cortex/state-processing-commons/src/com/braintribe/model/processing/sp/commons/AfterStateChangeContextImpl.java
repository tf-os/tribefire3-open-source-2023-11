...
/**
 *  a {@link AbstractStateChangeContext} implementation for the after process state change contesxt 
 * 
 * 
 * @author pit
 * @author dirk 
 ...
 */
public class AfterStateChangeContextImpl<T extends GenericEntity> extends AbstractPostStateChangeContext<T> implements AfterStateChangeContext<T> {
	private Map<EntityReference, PersistentEntityReference> referenceMap;
	
	
	public AfterStateChangeContextImpl( PersistenceGmSession userSession, PersistenceGmSession systemSession, EntityReference entityReference, EntityProperty entityProperty, Manipulation manipulation) {
