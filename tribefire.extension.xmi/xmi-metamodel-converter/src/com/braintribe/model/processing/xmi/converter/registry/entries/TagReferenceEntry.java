...
public class TagReferenceEntry extends RegistryEntry {

	private TagReference tagReference;
	private RegistryEntry parentEntry;
	...
	public RegistryEntry getParentEntry() {
		return parentEntry;
	}

	public void setParentEntry(RegistryEntry parentEntry) {
