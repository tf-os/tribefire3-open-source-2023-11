...
/**
 * Expert implementation to provide a {@link ScriptedServiceProcessor} based on {@link CommonScriptedProcessor}. 
 ...
 *
 */
public class ScriptedServiceProcessor extends CommonScriptedProcessor implements ReasonedServiceProcessor<ServiceRequest, Object> {

	@Override
	public Maybe<? extends Object> processReasoned(ServiceRequestContext requestContext, ServiceRequest request) {
