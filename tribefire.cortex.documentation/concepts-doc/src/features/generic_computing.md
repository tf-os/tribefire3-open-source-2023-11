...
We extended this "gödelization" by mapping all kinds of concepts (data, functionality, operations, configuration, etc.) to model types and further mapping those entity types to entity instances.
